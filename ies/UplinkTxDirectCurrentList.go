...
func (ie *UplinkTxDirectCurrentList) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*UplinkTxDirectCurrentCell]([]*UplinkTxDirectCurrentCell{}, aper.Constraint{Lb: 1, Ub: maxNrofServingCells}, false)
...
func (ie *UplinkTxDirectCurrentList) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*UplinkTxDirectCurrentCell]([]*UplinkTxDirectCurrentCell{}, aper.Constraint{Lb: 1, Ub: maxNrofServingCells}, false)
