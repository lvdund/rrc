...
type SecurityModeComplete_IEs struct {
	LateNonCriticalExtension *[]byte     `optional`
	NonCriticalExtension     interface{} `optional`
}

func (ie *SecurityModeComplete_IEs) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SecurityModeComplete_IEs) Decode(r *aper.AperReader) error {
	var err error
