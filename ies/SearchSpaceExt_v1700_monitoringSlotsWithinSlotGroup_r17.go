...
type SearchSpaceExt_v1700_monitoringSlotsWithinSlotGroup_r17 struct {
	Choice               uint64
	SlotGroupLength4_r17 aper.BitString `lb:4,ub:4,madatory`
	SlotGroupLength8_r17 aper.BitString `lb:8,ub:8,madatory`
}

func (ie *SearchSpaceExt_v1700_monitoringSlotsWithinSlotGroup_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	case SearchSpaceExt_v1700_monitoringSlotsWithinSlotGroup_r17_Choice_SlotGroupLength4_r17:
		if err = w.WriteBitString(ie.SlotGroupLength4_r17.Bytes, uint(ie.SlotGroupLength4_r17.NumBits), &aper.Constraint{Lb: 4, Ub: 4}, false); err != nil {
	...
	case SearchSpaceExt_v1700_monitoringSlotsWithinSlotGroup_r17_Choice_SlotGroupLength8_r17:
		if err = w.WriteBitString(ie.SlotGroupLength8_r17.Bytes, uint(ie.SlotGroupLength8_r17.NumBits), &aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
...
func (ie *SearchSpaceExt_v1700_monitoringSlotsWithinSlotGroup_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	case SearchSpaceExt_v1700_monitoringSlotsWithinSlotGroup_r17_Choice_SlotGroupLength4_r17:
		...
		if tmp_bs_SlotGroupLength4_r17, n_SlotGroupLength4_r17, err = r.ReadBitString(&aper.Constraint{Lb: 4, Ub: 4}, false); err != nil {
			return utils.WrapError("Decode SlotGroupLength4_r17", err)
		}
		ie.SlotGroupLength4_r17 = aper.BitString{
	...
	case SearchSpaceExt_v1700_monitoringSlotsWithinSlotGroup_r17_Choice_SlotGroupLength8_r17:
		...
		if tmp_bs_SlotGroupLength8_r17, n_SlotGroupLength8_r17, err = r.ReadBitString(&aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			return utils.WrapError("Decode SlotGroupLength8_r17", err)
		}
		ie.SlotGroupLength8_r17 = aper.BitString{
