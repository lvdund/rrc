...
func (ie *RLF_Report_r16_nr_RLF_Report_r16_measResultNeighCells_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RLF_Report_r16_nr_RLF_Report_r16_measResultNeighCells_r16) Decode(r *aper.AperReader) error {
	var err error
