...
func (ie *SearchSpace_monitoringSlotPeriodicityAndOffset) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SearchSpace_monitoringSlotPeriodicityAndOffset) Decode(r *aper.AperReader) error {
	var err error
