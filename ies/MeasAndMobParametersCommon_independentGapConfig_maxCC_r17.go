...
func (ie *MeasAndMobParametersCommon_independentGapConfig_maxCC_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasAndMobParametersCommon_independentGapConfig_maxCC_r17) Decode(r *aper.AperReader) error {
	var err error
