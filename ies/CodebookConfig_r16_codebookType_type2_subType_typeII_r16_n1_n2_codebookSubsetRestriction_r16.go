...
type CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16 struct {
	Choice      uint64
	Two_one     aper.BitString `lb:16,ub:16,madatory`
	Two_two     aper.BitString `lb:43,ub:43,madatory`
	Four_one    aper.BitString `lb:32,ub:32,madatory`
	Three_two   aper.BitString `lb:59,ub:59,madatory`
	Six_one     aper.BitString `lb:48,ub:48,madatory`
	Four_two    aper.BitString `lb:75,ub:75,madatory`
	Eight_one   aper.BitString `lb:64,ub:64,madatory`
	Four_three  aper.BitString `lb:107,ub:107,madatory`
	Six_two     aper.BitString `lb:107,ub:107,madatory`
	Twelve_one  aper.BitString `lb:96,ub:96,madatory`
	Four_four   aper.BitString `lb:139,ub:139,madatory`
	Eight_two   aper.BitString `lb:139,ub:139,madatory`
	Sixteen_one aper.BitString `lb:128,ub:128,madatory`
}

func (ie *CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Two_one:
		if err = w.WriteBitString(ie.Two_one.Bytes, uint(ie.Two_one.NumBits), &aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Two_two:
		if err = w.WriteBitString(ie.Two_two.Bytes, uint(ie.Two_two.NumBits), &aper.Constraint{Lb: 43, Ub: 43}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_one:
		if err = w.WriteBitString(ie.Four_one.Bytes, uint(ie.Four_one.NumBits), &aper.Constraint{Lb: 32, Ub: 32}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Three_two:
		if err = w.WriteBitString(ie.Three_two.Bytes, uint(ie.Three_two.NumBits), &aper.Constraint{Lb: 59, Ub: 59}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Six_one:
		if err = w.WriteBitString(ie.Six_one.Bytes, uint(ie.Six_one.NumBits), &aper.Constraint{Lb: 48, Ub: 48}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_two:
		if err = w.WriteBitString(ie.Four_two.Bytes, uint(ie.Four_two.NumBits), &aper.Constraint{Lb: 75, Ub: 75}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Eight_one:
		if err = w.WriteBitString(ie.Eight_one.Bytes, uint(ie.Eight_one.NumBits), &aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_three:
		if err = w.WriteBitString(ie.Four_three.Bytes, uint(ie.Four_three.NumBits), &aper.Constraint{Lb: 107, Ub: 107}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Six_two:
		if err = w.WriteBitString(ie.Six_two.Bytes, uint(ie.Six_two.NumBits), &aper.Constraint{Lb: 107, Ub: 107}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Twelve_one:
		if err = w.WriteBitString(ie.Twelve_one.Bytes, uint(ie.Twelve_one.NumBits), &aper.Constraint{Lb: 96, Ub: 96}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_four:
		if err = w.WriteBitString(ie.Four_four.Bytes, uint(ie.Four_four.NumBits), &aper.Constraint{Lb: 139, Ub: 139}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Eight_two:
		if err = w.WriteBitString(ie.Eight_two.Bytes, uint(ie.Eight_two.NumBits), &aper.Constraint{Lb: 139, Ub: 139}, false); err != nil {
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Sixteen_one:
		if err = w.WriteBitString(ie.Sixteen_one.Bytes, uint(ie.Sixteen_one.NumBits), &aper.Constraint{Lb: 128, Ub: 128}, false); err != nil {
...
func (ie *CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Two_one:
		...
		var n_Two_one uint
		if tmp_bs_Two_one, n_Two_one, err = r.ReadBitString(&aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
			return utils.WrapError("Decode Two_one", err)
		}
		ie.Two_one = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Two_two:
		...
		var n_Two_two uint
		if tmp_bs_Two_two, n_Two_two, err = r.ReadBitString(&aper.Constraint{Lb: 43, Ub: 43}, false); err != nil {
			return utils.WrapError("Decode Two_two", err)
		}
		ie.Two_two = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_one:
		...
		var n_Four_one uint
		if tmp_bs_Four_one, n_Four_one, err = r.ReadBitString(&aper.Constraint{Lb: 32, Ub: 32}, false); err != nil {
			return utils.WrapError("Decode Four_one", err)
		}
		ie.Four_one = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Three_two:
		...
		if tmp_bs_Three_two, n_Three_two, err = r.ReadBitString(&aper.Constraint{Lb: 59, Ub: 59}, false); err != nil {
			return utils.WrapError("Decode Three_two", err)
		}
		ie.Three_two = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Six_one:
		...
		var n_Six_one uint
		if tmp_bs_Six_one, n_Six_one, err = r.ReadBitString(&aper.Constraint{Lb: 48, Ub: 48}, false); err != nil {
			return utils.WrapError("Decode Six_one", err)
		}
		ie.Six_one = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_two:
		...
		var n_Four_two uint
		if tmp_bs_Four_two, n_Four_two, err = r.ReadBitString(&aper.Constraint{Lb: 75, Ub: 75}, false); err != nil {
			return utils.WrapError("Decode Four_two", err)
		}
		ie.Four_two = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Eight_one:
		...
		if tmp_bs_Eight_one, n_Eight_one, err = r.ReadBitString(&aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
			return utils.WrapError("Decode Eight_one", err)
		}
		ie.Eight_one = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_three:
		...
		if tmp_bs_Four_three, n_Four_three, err = r.ReadBitString(&aper.Constraint{Lb: 107, Ub: 107}, false); err != nil {
			return utils.WrapError("Decode Four_three", err)
		}
		ie.Four_three = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Six_two:
		...
		var n_Six_two uint
		if tmp_bs_Six_two, n_Six_two, err = r.ReadBitString(&aper.Constraint{Lb: 107, Ub: 107}, false); err != nil {
			return utils.WrapError("Decode Six_two", err)
		}
		ie.Six_two = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Twelve_one:
		...
		if tmp_bs_Twelve_one, n_Twelve_one, err = r.ReadBitString(&aper.Constraint{Lb: 96, Ub: 96}, false); err != nil {
			return utils.WrapError("Decode Twelve_one", err)
		}
		ie.Twelve_one = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Four_four:
		...
		if tmp_bs_Four_four, n_Four_four, err = r.ReadBitString(&aper.Constraint{Lb: 139, Ub: 139}, false); err != nil {
			return utils.WrapError("Decode Four_four", err)
		}
		ie.Four_four = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Eight_two:
		...
		if tmp_bs_Eight_two, n_Eight_two, err = r.ReadBitString(&aper.Constraint{Lb: 139, Ub: 139}, false); err != nil {
			return utils.WrapError("Decode Eight_two", err)
		}
		ie.Eight_two = aper.BitString{
	...
	case CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16_Choice_Sixteen_one:
		...
		if tmp_bs_Sixteen_one, n_Sixteen_one, err = r.ReadBitString(&aper.Constraint{Lb: 128, Ub: 128}, false); err != nil {
			return utils.WrapError("Decode Sixteen_one", err)
		}
		ie.Sixteen_one = aper.BitString{
