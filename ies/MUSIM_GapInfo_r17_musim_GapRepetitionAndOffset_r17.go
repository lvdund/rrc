...
func (ie *MUSIM_GapInfo_r17_musim_GapRepetitionAndOffset_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MUSIM_GapInfo_r17_musim_GapRepetitionAndOffset_r17) Decode(r *aper.AperReader) error {
	var err error
