...
func (ie *EUTRA_NS_PmaxValue) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.AdditionalPmax != nil {
		if err = w.WriteInteger(*ie.AdditionalPmax, &aper.Constraint{Lb: -30, Ub: 33}, false); err != nil {
			return utils.WrapError("Encode AdditionalPmax", err)
		}
	}
	if ie.AdditionalSpectrumEmission != nil {
		if err = w.WriteInteger(*ie.AdditionalSpectrumEmission, &aper.Constraint{Lb: 1, Ub: 288}, false); err != nil {
...
func (ie *EUTRA_NS_PmaxValue) Decode(r *aper.AperReader) error {
	var err error
	...
	if AdditionalPmaxPresent {
		...
		if tmp_int_AdditionalPmax, err = r.ReadInteger(&aper.Constraint{Lb: -30, Ub: 33}, false); err != nil {
	...
	if AdditionalSpectrumEmissionPresent {
		...
		if tmp_int_AdditionalSpectrumEmission, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 288}, false); err != nil {
