...
func (ie *SRS_PosResource_r16_transmissionComb_r16_n2_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.CombOffset_n2_r16, &aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
		return utils.WrapError("WriteInteger CombOffset_n2_r16", err)
	}
	if err = w.WriteInteger(ie.CyclicShift_n2_r16, &aper.Constraint{Lb: 0, Ub: 7}, false); err != nil {
		return utils.WrapError("WriteInteger CyclicShift_n2_r16", err)
	}
	return nil
}

func (ie *SRS_PosResource_r16_transmissionComb_r16_n2_r16) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_CombOffset_n2_r16 int64
	if tmp_int_CombOffset_n2_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
	...
	if tmp_int_CyclicShift_n2_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 7}, false); err != nil {
