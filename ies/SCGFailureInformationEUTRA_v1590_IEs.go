...
func (ie *SCGFailureInformationEUTRA_v1590_IEs) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SCGFailureInformationEUTRA_v1590_IEs) Decode(r *aper.AperReader) error {
	var err error
