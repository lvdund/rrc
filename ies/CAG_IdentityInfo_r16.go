...
type CAG_IdentityInfo_r16 struct {
	Cag_Identity_r16              aper.BitString                                      `lb:32,ub:32,madatory`
	ManualCAGselectionAllowed_r16 *CAG_IdentityInfo_r16_manualCAGselectionAllowed_r16 `optional`
}

func (ie *CAG_IdentityInfo_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteBitString(ie.Cag_Identity_r16.Bytes, uint(ie.Cag_Identity_r16.NumBits), &aper.Constraint{Lb: 32, Ub: 32}, false); err != nil {
...
func (ie *CAG_IdentityInfo_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_bs_Cag_Identity_r16, n_Cag_Identity_r16, err = r.ReadBitString(&aper.Constraint{Lb: 32, Ub: 32}, false); err != nil {
		return utils.WrapError("ReadBitString Cag_Identity_r16", err)
	}
	ie.Cag_Identity_r16 = aper.BitString{
