...
type MeasObjectRxTxDiff_r17_dl_Ref_r17 struct {
	Choice         uint64
	Prs_Ref_r17    aper.NULL `madatory`
	Csi_RS_Ref_r17 aper.NULL `madatory`
}

func (ie *MeasObjectRxTxDiff_r17_dl_Ref_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasObjectRxTxDiff_r17_dl_Ref_r17) Decode(r *aper.AperReader) error {
	var err error
