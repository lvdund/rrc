...
func (ie *MBS_NeighbourCellList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MBS_NeighbourCell_r17]([]*MBS_NeighbourCell_r17{}, aper.Constraint{Lb: 0, Ub: maxNeighCellMBS_r17}, false)
...
func (ie *MBS_NeighbourCellList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MBS_NeighbourCell_r17]([]*MBS_NeighbourCell_r17{}, aper.Constraint{Lb: 0, Ub: maxNeighCellMBS_r17}, false)
