...
func (ie *CA_ParametersNR_v1720_dynamicPUCCH_CellSwitchDiffLengthSingleGroup_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CA_ParametersNR_v1720_dynamicPUCCH_CellSwitchDiffLengthSingleGroup_r17) Decode(r *aper.AperReader) error {
	var err error
