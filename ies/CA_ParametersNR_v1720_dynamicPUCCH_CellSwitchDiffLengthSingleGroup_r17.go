...
type CA_ParametersNR_v1720_dynamicPUCCH_CellSwitchDiffLengthSingleGroup_r17 struct {
	Pucch_Group_r17        CA_ParametersNR_v1720_dynamicPUCCH_CellSwitchDiffLengthSingleGroup_r17_pucch_Group_r17 `madatory`
	Pucch_Group_Config_r17 PUCCH_Group_Config_r17                                                                 `madatory`
}

func (ie *CA_ParametersNR_v1720_dynamicPUCCH_CellSwitchDiffLengthSingleGroup_r17) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *CA_ParametersNR_v1720_dynamicPUCCH_CellSwitchDiffLengthSingleGroup_r17) Decode(r *uper.UperReader) error {
	var err error
