...
func (ie *VisitedCellInfo_r16_visitedCellId_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *VisitedCellInfo_r16_visitedCellId_r16) Decode(r *aper.AperReader) error {
	var err error
