...
type DL_DataToUL_ACK_DCI_1_2_r16 struct {
	Value []int64 `lb:1,ub:8,madatory`
}

func (ie *DL_DataToUL_ACK_DCI_1_2_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *DL_DataToUL_ACK_DCI_1_2_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: 8}, false)
