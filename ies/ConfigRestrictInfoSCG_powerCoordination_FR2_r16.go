...
func (ie *ConfigRestrictInfoSCG_powerCoordination_FR2_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ConfigRestrictInfoSCG_powerCoordination_FR2_r16) Decode(r *aper.AperReader) error {
	var err error
