...
func (ie *SL_SyncConfigList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_SyncConfig_r16]([]*SL_SyncConfig_r16{}, aper.Constraint{Lb: 1, Ub: maxSL_SyncConfig_r16}, false)
...
func (ie *SL_SyncConfigList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_SyncConfig_r16]([]*SL_SyncConfig_r16{}, aper.Constraint{Lb: 1, Ub: maxSL_SyncConfig_r16}, false)
