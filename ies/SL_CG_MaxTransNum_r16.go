...
func (ie *SL_CG_MaxTransNum_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.Sl_MaxTransNum_r16, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_MaxTransNum_r16", err)
	}
	return nil
}

func (ie *SL_CG_MaxTransNum_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_Sl_MaxTransNum_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
