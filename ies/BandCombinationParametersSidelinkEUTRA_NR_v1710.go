...
func (ie *BandCombinationParametersSidelinkEUTRA_NR_v1710) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandParametersSidelinkEUTRA_NR_v1710]([]*BandParametersSidelinkEUTRA_NR_v1710{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
...
func (ie *BandCombinationParametersSidelinkEUTRA_NR_v1710) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandParametersSidelinkEUTRA_NR_v1710]([]*BandParametersSidelinkEUTRA_NR_v1710{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
