...
type FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot struct {
	Scs_15kHz  *FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot_scs_15kHz  `optional`
	Scs_30kHz  *FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot_scs_30kHz  `optional`
	Scs_60kHz  *FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot_scs_60kHz  `optional`
...
func (ie *FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot) Decode(r *aper.AperReader) error {
	...
	if Scs_15kHzPresent {
		ie.Scs_15kHz = new(FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot_scs_15kHz)
		if err = ie.Scs_15kHz.Decode(r); err != nil {
			return utils.WrapError("Decode Scs_15kHz", err)
		}
	}
	if Scs_30kHzPresent {
		ie.Scs_30kHz = new(FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot_scs_30kHz)
		if err = ie.Scs_30kHz.Decode(r); err != nil {
			return utils.WrapError("Decode Scs_30kHz", err)
		}
	}
	if Scs_60kHzPresent {
		ie.Scs_60kHz = new(FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot_scs_60kHz)
		if err = ie.Scs_60kHz.Decode(r); err != nil {
			return utils.WrapError("Decode Scs_60kHz", err)
		}
	}
	if Scs_120kHzPresent {
		ie.Scs_120kHz = new(FeatureSetDownlink_pdsch_ProcessingType1_DifferentTB_PerSlot_scs_120kHz)
