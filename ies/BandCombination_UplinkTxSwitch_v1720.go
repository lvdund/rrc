...
func (ie *BandCombination_UplinkTxSwitch_v1720) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *BandCombination_UplinkTxSwitch_v1720) Decode(r *aper.AperReader) error {
	var err error
