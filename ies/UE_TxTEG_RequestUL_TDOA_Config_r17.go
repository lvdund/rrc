...
type UE_TxTEG_RequestUL_TDOA_Config_r17 struct {
	Choice                uint64
	OneShot_r17           aper.NULL `madatory`
	PeriodicReporting_r17 *UE_TxTEG_RequestUL_TDOA_Config_r17_periodicReporting_r17
}

func (ie *UE_TxTEG_RequestUL_TDOA_Config_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UE_TxTEG_RequestUL_TDOA_Config_r17) Decode(r *aper.AperReader) error {
	var err error
