...
func (ie *PEI_Config_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.PayloadSizeDCI_2_7_r17, &aper.Constraint{Lb: 1, Ub: maxDCI_2_7_Size_r17}, false); err != nil {
		return utils.WrapError("WriteInteger PayloadSizeDCI_2_7_r17", err)
	}
	if err = w.WriteInteger(ie.Pei_FrameOffset_r17, &aper.Constraint{Lb: 0, Ub: 16}, false); err != nil {
...
func (ie *PEI_Config_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_PayloadSizeDCI_2_7_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxDCI_2_7_Size_r17}, false); err != nil {
	...
	if tmp_int_Pei_FrameOffset_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 16}, false); err != nil {
