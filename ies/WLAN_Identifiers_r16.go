...
func (ie *WLAN_Identifiers_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Ssid_r16 != nil {
		if err = w.WriteOctetString(*ie.Ssid_r16, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
			return utils.WrapError("Encode Ssid_r16", err)
		}
	}
	if ie.Bssid_r16 != nil {
		if err = w.WriteOctetString(*ie.Bssid_r16, &aper.Constraint{Lb: 6, Ub: 6}, false); err != nil {
			return utils.WrapError("Encode Bssid_r16", err)
		}
	}
	if ie.Hessid_r16 != nil {
		if err = w.WriteOctetString(*ie.Hessid_r16, &aper.Constraint{Lb: 6, Ub: 6}, false); err != nil {
...
func (ie *WLAN_Identifiers_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if Ssid_r16Present {
		...
		if tmp_os_Ssid_r16, err = r.ReadOctetString(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
	...
	if Bssid_r16Present {
		...
		if tmp_os_Bssid_r16, err = r.ReadOctetString(&aper.Constraint{Lb: 6, Ub: 6}, false); err != nil {
	...
	if Hessid_r16Present {
		...
		if tmp_os_Hessid_r16, err = r.ReadOctetString(&aper.Constraint{Lb: 6, Ub: 6}, false); err != nil {
