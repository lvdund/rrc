...
type CA_ParametersNR_v1640_pdcch_BlindDetectionCA_Mixed_NonAlignedSpan_r16 struct {
	Pdcch_BlindDetectionCA1_r16 int64 `lb:1,ub:15,madatory`
	Pdcch_BlindDetectionCA2_r16 int64 `lb:1,ub:15,madatory`
}

func (ie *CA_ParametersNR_v1640_pdcch_BlindDetectionCA_Mixed_NonAlignedSpan_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *CA_ParametersNR_v1640_pdcch_BlindDetectionCA_Mixed_NonAlignedSpan_r16) Decode(r *uper.UperReader) error {
	var err error
