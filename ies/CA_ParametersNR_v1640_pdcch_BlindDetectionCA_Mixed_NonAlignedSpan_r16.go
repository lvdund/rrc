...
func (ie *CA_ParametersNR_v1640_pdcch_BlindDetectionCA_Mixed_NonAlignedSpan_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CA_ParametersNR_v1640_pdcch_BlindDetectionCA_Mixed_NonAlignedSpan_r16) Decode(r *aper.AperReader) error {
	var err error
