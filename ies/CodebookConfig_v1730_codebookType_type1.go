...
func (ie *CodebookConfig_v1730_codebookType_type1) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CodebookConfig_v1730_codebookType_type1) Decode(r *aper.AperReader) error {
	var err error
