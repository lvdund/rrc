...
func (ie *BandCombinationListSidelinkNR_v1710) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombinationParametersSidelinkNR_v1710]([]*BandCombinationParametersSidelinkNR_v1710{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationListSidelinkNR_v1710) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombinationParametersSidelinkNR_v1710]([]*BandCombinationParametersSidelinkNR_v1710{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
