...
func (ie *PUCCH_PathlossReferenceRS_referenceSignal) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PUCCH_PathlossReferenceRS_referenceSignal) Decode(r *aper.AperReader) error {
	var err error
