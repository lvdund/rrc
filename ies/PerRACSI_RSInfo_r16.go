...
func (ie *PerRACSI_RSInfo_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = ie.Csi_RS_Index_r16.Encode(w); err != nil {
		return utils.WrapError("Encode Csi_RS_Index_r16", err)
	}
	if err = w.WriteInteger(ie.NumberOfPreamblesSentOnCSI_RS_r16, &aper.Constraint{Lb: 1, Ub: 200}, false); err != nil {
		return utils.WrapError("WriteInteger NumberOfPreamblesSentOnCSI_RS_r16", err)
	}
	return nil
}

func (ie *PerRACSI_RSInfo_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_NumberOfPreamblesSentOnCSI_RS_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 200}, false); err != nil {
