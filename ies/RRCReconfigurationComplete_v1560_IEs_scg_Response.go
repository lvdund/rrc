...
func (ie *RRCReconfigurationComplete_v1560_IEs_scg_Response) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RRCReconfigurationComplete_v1560_IEs_scg_Response) Decode(r *aper.AperReader) error {
	var err error
