...
func (ie *CG_Config_v1560_IEs_reportCGI_RequestEUTRA) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CG_Config_v1560_IEs_reportCGI_RequestEUTRA) Decode(r *aper.AperReader) error {
	var err error
