...
func (ie *EventTriggerConfig_eventId_eventX2_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *EventTriggerConfig_eventId_eventX2_r17) Decode(r *aper.AperReader) error {
	var err error
