...
func (ie *CSI_AperiodicTriggerStateList) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*CSI_AperiodicTriggerState]([]*CSI_AperiodicTriggerState{}, aper.Constraint{Lb: 1, Ub: maxNrOfCSI_AperiodicTriggers}, false)
...
func (ie *CSI_AperiodicTriggerStateList) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*CSI_AperiodicTriggerState]([]*CSI_AperiodicTriggerState{}, aper.Constraint{Lb: 1, Ub: maxNrOfCSI_AperiodicTriggers}, false)
