...
func (ie *PDCCH_BlindDetectionCG_UE_Mixed1_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.Pdcch_BlindDetectionCG_UE1_r17, &aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
		return utils.WrapError("WriteInteger Pdcch_BlindDetectionCG_UE1_r17", err)
	}
	if err = w.WriteInteger(ie.Pdcch_BlindDetectionCG_UE2_r17, &aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
		return utils.WrapError("WriteInteger Pdcch_BlindDetectionCG_UE2_r17", err)
	}
	if err = w.WriteInteger(ie.Pdcch_BlindDetectionCG_UE3_r17, &aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
		return utils.WrapError("WriteInteger Pdcch_BlindDetectionCG_UE3_r17", err)
	}
	return nil
}

func (ie *PDCCH_BlindDetectionCG_UE_Mixed1_r17) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_Pdcch_BlindDetectionCG_UE1_r17 int64
	if tmp_int_Pdcch_BlindDetectionCG_UE1_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
	...
	if tmp_int_Pdcch_BlindDetectionCG_UE2_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
	...
	if tmp_int_Pdcch_BlindDetectionCG_UE3_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
