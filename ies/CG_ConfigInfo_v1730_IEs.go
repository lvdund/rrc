...
func (ie *CG_ConfigInfo_v1730_IEs) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Fr1_Carriers_MCG_r17 != nil {
		if err = w.WriteInteger(*ie.Fr1_Carriers_MCG_r17, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
			return utils.WrapError("Encode Fr1_Carriers_MCG_r17", err)
		}
	}
	if ie.Fr2_Carriers_MCG_r17 != nil {
		if err = w.WriteInteger(*ie.Fr2_Carriers_MCG_r17, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
...
func (ie *CG_ConfigInfo_v1730_IEs) Decode(r *aper.AperReader) error {
	var err error
	...
	if Fr1_Carriers_MCG_r17Present {
		...
		if tmp_int_Fr1_Carriers_MCG_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
	...
	if Fr2_Carriers_MCG_r17Present {
		...
		if tmp_int_Fr2_Carriers_MCG_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
