...
func (ie *CandidateBeamRS_r16_candidateBeamConfig_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CandidateBeamRS_r16_candidateBeamConfig_r16) Decode(r *aper.AperReader) error {
	var err error
