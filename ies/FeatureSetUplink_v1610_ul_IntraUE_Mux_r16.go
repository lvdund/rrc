...
func (ie *FeatureSetUplink_v1610_ul_IntraUE_Mux_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *FeatureSetUplink_v1610_ul_IntraUE_Mux_r16) Decode(r *aper.AperReader) error {
	var err error
