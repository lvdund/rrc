...
// Source: MeasQuantityResults (line 9809).

var measQuantityResultsConstraints = per.SequenceConstraints{
	Extensible: false,
...
func (ie *MeasQuantityResults) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(measQuantityResultsConstraints)
...
func (ie *MeasQuantityResults) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(measQuantityResultsConstraints)
