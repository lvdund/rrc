...
func (ie *MIMO_ParametersPerBand_semi_PersistentL1_SINR_Report_PUCCH_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MIMO_ParametersPerBand_semi_PersistentL1_SINR_Report_PUCCH_r16) Decode(r *aper.AperReader) error {
	var err error
