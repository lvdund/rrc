...
func (ie *BandParameters_v1540_srs_CarrierSwitch) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *BandParameters_v1540_srs_CarrierSwitch) Decode(r *aper.AperReader) error {
	var err error
