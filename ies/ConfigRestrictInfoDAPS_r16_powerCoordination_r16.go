...
func (ie *ConfigRestrictInfoDAPS_r16_powerCoordination_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ConfigRestrictInfoDAPS_r16_powerCoordination_r16) Decode(r *aper.AperReader) error {
	var err error
