...
type RRCSetupComplete struct {
	...
	CriticalExtensions        RRCSetupComplete_CriticalExtensions `madatory`
}

func (ie *RRCSetupComplete) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *RRCSetupComplete) Decode(r *uper.UperReader) error {
	var err error
