...
func (ie *SSB_PositionQCL_CellsToAddModList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SSB_PositionQCL_CellsToAddMod_r16]([]*SSB_PositionQCL_CellsToAddMod_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofCellMeas}, false)
...
func (ie *SSB_PositionQCL_CellsToAddModList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SSB_PositionQCL_CellsToAddMod_r16]([]*SSB_PositionQCL_CellsToAddMod_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofCellMeas}, false)
