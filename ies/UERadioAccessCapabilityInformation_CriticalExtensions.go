...
func (ie *UERadioAccessCapabilityInformation_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UERadioAccessCapabilityInformation_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
