...
func (ie *MUSIM_GapId_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(int64(ie.Value), &aper.Constraint{Lb: 0, Ub: 2}, false); err != nil {
		return utils.WrapError("Encode MUSIM_GapId_r17", err)
	}
	return nil
}

func (ie *MUSIM_GapId_r17) Decode(r *aper.AperReader) error {
	var err error
	var v int64
