...
func (ie *MeasAndMobParametersMRDC_Common_v1700) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasAndMobParametersMRDC_Common_v1700) Decode(r *aper.AperReader) error {
	var err error
