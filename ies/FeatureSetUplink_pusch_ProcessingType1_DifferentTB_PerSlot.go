...
func (ie *FeatureSetUplink_pusch_ProcessingType1_DifferentTB_PerSlot) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *FeatureSetUplink_pusch_ProcessingType1_DifferentTB_PerSlot) Decode(r *aper.AperReader) error {
	var err error
