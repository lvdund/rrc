...
func (ie *P0_PUCCH) Encode(w *aper.AperWriter) error {
	var err error
	if err = ie.P0_PUCCH_Id.Encode(w); err != nil {
		return utils.WrapError("Encode P0_PUCCH_Id", err)
	}
	if err = w.WriteInteger(ie.P0_PUCCH_Value, &aper.Constraint{Lb: -16, Ub: 15}, false); err != nil {
		return utils.WrapError("WriteInteger P0_PUCCH_Value", err)
	}
	return nil
}

func (ie *P0_PUCCH) Decode(r *aper.AperReader) error {
	var err error
	if err = ie.P0_PUCCH_Id.Decode(r); err != nil {
		return utils.WrapError("Decode P0_PUCCH_Id", err)
	}
	var tmp_int_P0_PUCCH_Value int64
	if tmp_int_P0_PUCCH_Value, err = r.ReadInteger(&aper.Constraint{Lb: -16, Ub: 15}, false); err != nil {
