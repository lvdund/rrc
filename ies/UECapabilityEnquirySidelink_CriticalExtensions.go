...
func (ie *UECapabilityEnquirySidelink_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UECapabilityEnquirySidelink_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
