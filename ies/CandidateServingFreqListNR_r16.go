...
func (ie *CandidateServingFreqListNR_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*ARFCN_ValueNR]([]*ARFCN_ValueNR{}, aper.Constraint{Lb: 1, Ub: maxFreqIDC_r16}, false)
...
func (ie *CandidateServingFreqListNR_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*ARFCN_ValueNR]([]*ARFCN_ValueNR{}, aper.Constraint{Lb: 1, Ub: maxFreqIDC_r16}, false)
