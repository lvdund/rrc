...
type CA_ParametersNR_v1700_non_AlignedFrameBoundaries_r17 struct {
	Scs15kHz_15kHz_r17 *uper.BitString `lb:1,ub:496,optional`
	Scs15kHz_30kHz_r17 *uper.BitString `lb:1,ub:496,optional`
	Scs15kHz_60kHz_r17 *uper.BitString `lb:1,ub:496,optional`
...
func (ie *CA_ParametersNR_v1700_non_AlignedFrameBoundaries_r17) Encode(w *uper.UperWriter) error {
	var err error
	...
	if ie.Scs15kHz_15kHz_r17 != nil {
		if err = w.WriteBitString(ie.Scs15kHz_15kHz_r17.Bytes, uint(ie.Scs15kHz_15kHz_r17.NumBits), &uper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
			return utils.WrapError("Encode Scs15kHz_15kHz_r17", err)
		}
	}
	if ie.Scs15kHz_30kHz_r17 != nil {
		if err = w.WriteBitString(ie.Scs15kHz_30kHz_r17.Bytes, uint(ie.Scs15kHz_30kHz_r17.NumBits), &uper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
			return utils.WrapError("Encode Scs15kHz_30kHz_r17", err)
		}
	}
	if ie.Scs15kHz_60kHz_r17 != nil {
		if err = w.WriteBitString(ie.Scs15kHz_60kHz_r17.Bytes, uint(ie.Scs15kHz_60kHz_r17.NumBits), &uper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
...
func (ie *CA_ParametersNR_v1700_non_AlignedFrameBoundaries_r17) Decode(r *uper.UperReader) error {
	var err error
	...
	if Scs15kHz_15kHz_r17Present {
		var tmp_bs_Scs15kHz_15kHz_r17 []byte
		var n_Scs15kHz_15kHz_r17 uint
		if tmp_bs_Scs15kHz_15kHz_r17, n_Scs15kHz_15kHz_r17, err = r.ReadBitString(&uper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
			return utils.WrapError("Decode Scs15kHz_15kHz_r17", err)
		}
		tmp_bitstring := uper.BitString{
			Bytes:   tmp_bs_Scs15kHz_15kHz_r17,
			NumBits: uint64(n_Scs15kHz_15kHz_r17),
		}
		ie.Scs15kHz_15kHz_r17 = &tmp_bitstring
	}
	if Scs15kHz_30kHz_r17Present {
		var tmp_bs_Scs15kHz_30kHz_r17 []byte
		var n_Scs15kHz_30kHz_r17 uint
		if tmp_bs_Scs15kHz_30kHz_r17, n_Scs15kHz_30kHz_r17, err = r.ReadBitString(&uper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
			return utils.WrapError("Decode Scs15kHz_30kHz_r17", err)
		}
		tmp_bitstring := uper.BitString{
			Bytes:   tmp_bs_Scs15kHz_30kHz_r17,
			NumBits: uint64(n_Scs15kHz_30kHz_r17),
		}
		ie.Scs15kHz_30kHz_r17 = &tmp_bitstring
	}
	if Scs15kHz_60kHz_r17Present {
		var tmp_bs_Scs15kHz_60kHz_r17 []byte
		var n_Scs15kHz_60kHz_r17 uint
		if tmp_bs_Scs15kHz_60kHz_r17, n_Scs15kHz_60kHz_r17, err = r.ReadBitString(&uper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
			return utils.WrapError("Decode Scs15kHz_60kHz_r17", err)
		}
		tmp_bitstring := uper.BitString{
			Bytes:   tmp_bs_Scs15kHz_60kHz_r17,
			NumBits: uint64(n_Scs15kHz_60kHz_r17),
		}
		ie.Scs15kHz_60kHz_r17 = &tmp_bitstring
	}
