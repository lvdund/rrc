...
type CA_ParametersNR_v1700_non_AlignedFrameBoundaries_r17 struct {
	Scs15kHz_15kHz_r17 *aper.BitString `lb:1,ub:496,optional`
	Scs15kHz_30kHz_r17 *aper.BitString `lb:1,ub:496,optional`
	Scs15kHz_60kHz_r17 *aper.BitString `lb:1,ub:496,optional`
...
func (ie *CA_ParametersNR_v1700_non_AlignedFrameBoundaries_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Scs15kHz_15kHz_r17 != nil {
		if err = w.WriteBitString(ie.Scs15kHz_15kHz_r17.Bytes, uint(ie.Scs15kHz_15kHz_r17.NumBits), &aper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
			return utils.WrapError("Encode Scs15kHz_15kHz_r17", err)
		}
	}
	if ie.Scs15kHz_30kHz_r17 != nil {
		if err = w.WriteBitString(ie.Scs15kHz_30kHz_r17.Bytes, uint(ie.Scs15kHz_30kHz_r17.NumBits), &aper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
			return utils.WrapError("Encode Scs15kHz_30kHz_r17", err)
		}
	}
	if ie.Scs15kHz_60kHz_r17 != nil {
		if err = w.WriteBitString(ie.Scs15kHz_60kHz_r17.Bytes, uint(ie.Scs15kHz_60kHz_r17.NumBits), &aper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
...
func (ie *CA_ParametersNR_v1700_non_AlignedFrameBoundaries_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if Scs15kHz_15kHz_r17Present {
		...
		if tmp_bs_Scs15kHz_15kHz_r17, n_Scs15kHz_15kHz_r17, err = r.ReadBitString(&aper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
	...
	if Scs15kHz_30kHz_r17Present {
		...
		if tmp_bs_Scs15kHz_30kHz_r17, n_Scs15kHz_30kHz_r17, err = r.ReadBitString(&aper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
	...
	if Scs15kHz_60kHz_r17Present {
		...
		if tmp_bs_Scs15kHz_60kHz_r17, n_Scs15kHz_60kHz_r17, err = r.ReadBitString(&aper.Constraint{Lb: 1, Ub: 496}, false); err != nil {
