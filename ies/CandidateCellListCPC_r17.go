...
func (ie *CandidateCellListCPC_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*CandidateCellCPC_r17]([]*CandidateCellCPC_r17{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
...
func (ie *CandidateCellListCPC_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*CandidateCellCPC_r17]([]*CandidateCellCPC_r17{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
