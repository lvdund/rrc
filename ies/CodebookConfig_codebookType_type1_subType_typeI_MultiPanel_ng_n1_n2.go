...
type CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2 struct {
	Choice                                     uint64
	Two_two_one_TypeI_MultiPanel_Restriction   aper.BitString `lb:8,ub:8,madatory`
	Two_four_one_TypeI_MultiPanel_Restriction  aper.BitString `lb:16,ub:16,madatory`
	Four_two_one_TypeI_MultiPanel_Restriction  aper.BitString `lb:8,ub:8,madatory`
	Two_two_two_TypeI_MultiPanel_Restriction   aper.BitString `lb:64,ub:64,madatory`
	Two_eight_one_TypeI_MultiPanel_Restriction aper.BitString `lb:32,ub:32,madatory`
	Four_four_one_TypeI_MultiPanel_Restriction aper.BitString `lb:16,ub:16,madatory`
	Two_four_two_TypeI_MultiPanel_Restriction  aper.BitString `lb:128,ub:128,madatory`
	Four_two_two_TypeI_MultiPanel_Restriction  aper.BitString `lb:64,ub:64,madatory`
}

func (ie *CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2) Encode(w *aper.AperWriter) error {
	var err error
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_two_one_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Two_two_one_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Two_two_one_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_four_one_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Two_four_one_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Two_four_one_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Four_two_one_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Four_two_one_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Four_two_one_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_two_two_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Two_two_two_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Two_two_two_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_eight_one_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Two_eight_one_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Two_eight_one_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 32, Ub: 32}, false); err != nil {
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Four_four_one_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Four_four_one_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Four_four_one_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_four_two_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Two_four_two_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Two_four_two_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 128, Ub: 128}, false); err != nil {
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Four_two_two_TypeI_MultiPanel_Restriction:
		if err = w.WriteBitString(ie.Four_two_two_TypeI_MultiPanel_Restriction.Bytes, uint(ie.Four_two_two_TypeI_MultiPanel_Restriction.NumBits), &aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
...
func (ie *CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2) Decode(r *aper.AperReader) error {
	var err error
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_two_one_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Two_two_one_TypeI_MultiPanel_Restriction, n_Two_two_one_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			return utils.WrapError("Decode Two_two_one_TypeI_MultiPanel_Restriction", err)
		}
		ie.Two_two_one_TypeI_MultiPanel_Restriction = aper.BitString{
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_four_one_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Two_four_one_TypeI_MultiPanel_Restriction, n_Two_four_one_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
			return utils.WrapError("Decode Two_four_one_TypeI_MultiPanel_Restriction", err)
		}
		ie.Two_four_one_TypeI_MultiPanel_Restriction = aper.BitString{
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Four_two_one_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Four_two_one_TypeI_MultiPanel_Restriction, n_Four_two_one_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			return utils.WrapError("Decode Four_two_one_TypeI_MultiPanel_Restriction", err)
		}
		ie.Four_two_one_TypeI_MultiPanel_Restriction = aper.BitString{
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_two_two_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Two_two_two_TypeI_MultiPanel_Restriction, n_Two_two_two_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
			return utils.WrapError("Decode Two_two_two_TypeI_MultiPanel_Restriction", err)
		}
		ie.Two_two_two_TypeI_MultiPanel_Restriction = aper.BitString{
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_eight_one_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Two_eight_one_TypeI_MultiPanel_Restriction, n_Two_eight_one_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 32, Ub: 32}, false); err != nil {
			return utils.WrapError("Decode Two_eight_one_TypeI_MultiPanel_Restriction", err)
		}
		ie.Two_eight_one_TypeI_MultiPanel_Restriction = aper.BitString{
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Four_four_one_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Four_four_one_TypeI_MultiPanel_Restriction, n_Four_four_one_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
			return utils.WrapError("Decode Four_four_one_TypeI_MultiPanel_Restriction", err)
		}
		ie.Four_four_one_TypeI_MultiPanel_Restriction = aper.BitString{
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Two_four_two_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Two_four_two_TypeI_MultiPanel_Restriction, n_Two_four_two_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 128, Ub: 128}, false); err != nil {
			return utils.WrapError("Decode Two_four_two_TypeI_MultiPanel_Restriction", err)
		}
		ie.Two_four_two_TypeI_MultiPanel_Restriction = aper.BitString{
	...
	case CodebookConfig_codebookType_type1_subType_typeI_MultiPanel_ng_n1_n2_Choice_Four_two_two_TypeI_MultiPanel_Restriction:
		...
		if tmp_bs_Four_two_two_TypeI_MultiPanel_Restriction, n_Four_two_two_TypeI_MultiPanel_Restriction, err = r.ReadBitString(&aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
			return utils.WrapError("Decode Four_two_two_TypeI_MultiPanel_Restriction", err)
		}
		ie.Four_two_two_TypeI_MultiPanel_Restriction = aper.BitString{
