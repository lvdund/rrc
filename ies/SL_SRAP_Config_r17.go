...
func (ie *SL_SRAP_Config_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Sl_LocalIdentity_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_LocalIdentity_r17, &aper.Constraint{Lb: 0, Ub: 255}, false); err != nil {
			return utils.WrapError("Encode Sl_LocalIdentity_r17", err)
		}
	}
	if len(ie.Sl_MappingToAddModList_r17) > 0 {
		tmp_Sl_MappingToAddModList_r17 := utils.NewSequence[*SL_MappingToAddMod_r17]([]*SL_MappingToAddMod_r17{}, aper.Constraint{Lb: 1, Ub: maxLC_ID}, false)
	...
	if len(ie.Sl_MappingToReleaseList_r17) > 0 {
		tmp_Sl_MappingToReleaseList_r17 := utils.NewSequence[*SL_RemoteUE_RB_Identity_r17]([]*SL_RemoteUE_RB_Identity_r17{}, aper.Constraint{Lb: 1, Ub: maxLC_ID}, false)
...
func (ie *SL_SRAP_Config_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if Sl_LocalIdentity_r17Present {
		...
		if tmp_int_Sl_LocalIdentity_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 255}, false); err != nil {
