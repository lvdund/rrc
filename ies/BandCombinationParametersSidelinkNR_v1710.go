...
func (ie *BandCombinationParametersSidelinkNR_v1710) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandParametersSidelink_v1710]([]*BandParametersSidelink_v1710{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
...
func (ie *BandCombinationParametersSidelinkNR_v1710) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandParametersSidelink_v1710]([]*BandParametersSidelink_v1710{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
