...
func (ie *PUCCH_PathlossReferenceRS_r16_referenceSignal_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PUCCH_PathlossReferenceRS_r16_referenceSignal_r16) Decode(r *aper.AperReader) error {
	var err error
