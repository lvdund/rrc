...
func (ie *Phy_ParametersCommon_sps_HARQ_ACK_Deferral_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *Phy_ParametersCommon_sps_HARQ_ACK_Deferral_r17) Decode(r *aper.AperReader) error {
	var err error
