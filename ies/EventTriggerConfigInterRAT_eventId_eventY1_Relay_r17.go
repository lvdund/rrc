...
func (ie *EventTriggerConfigInterRAT_eventId_eventY1_Relay_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *EventTriggerConfigInterRAT_eventId_eventY1_Relay_r17) Decode(r *aper.AperReader) error {
	var err error
