...
type RRCReconfigurationFailureSidelink struct {
	...
	CriticalExtensions            RRCReconfigurationFailureSidelink_CriticalExtensions `madatory`
}

func (ie *RRCReconfigurationFailureSidelink) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *RRCReconfigurationFailureSidelink) Decode(r *uper.UperReader) error {
	var err error
