...
type RACH_ConfigCommon_ra_PrioritizationForAccessIdentity_r16 struct {
	Ra_Prioritization_r16      RA_Prioritization `madatory`
	Ra_PrioritizationForAI_r16 aper.BitString    `lb:2,ub:2,madatory`
}

func (ie *RACH_ConfigCommon_ra_PrioritizationForAccessIdentity_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RACH_ConfigCommon_ra_PrioritizationForAccessIdentity_r16) Decode(r *aper.AperReader) error {
	var err error
