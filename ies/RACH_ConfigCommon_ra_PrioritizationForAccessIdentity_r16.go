...
func (ie *RACH_ConfigCommon_ra_PrioritizationForAccessIdentity_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *RACH_ConfigCommon_ra_PrioritizationForAccessIdentity_r16) Decode(r *uper.UperReader) error {
	var err error
