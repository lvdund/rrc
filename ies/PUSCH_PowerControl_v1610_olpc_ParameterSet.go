...
func (ie *PUSCH_PowerControl_v1610_olpc_ParameterSet) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Olpc_ParameterSetDCI_0_1_r16 != nil {
		if err = w.WriteInteger(*ie.Olpc_ParameterSetDCI_0_1_r16, &aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
			return utils.WrapError("Encode Olpc_ParameterSetDCI_0_1_r16", err)
		}
	}
	if ie.Olpc_ParameterSetDCI_0_2_r16 != nil {
		if err = w.WriteInteger(*ie.Olpc_ParameterSetDCI_0_2_r16, &aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
...
func (ie *PUSCH_PowerControl_v1610_olpc_ParameterSet) Decode(r *aper.AperReader) error {
	var err error
	...
	if Olpc_ParameterSetDCI_0_1_r16Present {
		...
		if tmp_int_Olpc_ParameterSetDCI_0_1_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
	...
	if Olpc_ParameterSetDCI_0_2_r16Present {
		...
		if tmp_int_Olpc_ParameterSetDCI_0_2_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
