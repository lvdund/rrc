...
func (ie *NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs60_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs60_r17) Decode(r *aper.AperReader) error {
	var err error
