...
func (ie *MIMO_ParametersPerBand_beamSwitchTiming_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MIMO_ParametersPerBand_beamSwitchTiming_r17) Decode(r *aper.AperReader) error {
	var err error
