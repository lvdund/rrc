...
func (ie *FeatureSetDownlink_v1700_mTRP_PDCCH_Case2_1SpanGap_r17) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *FeatureSetDownlink_v1700_mTRP_PDCCH_Case2_1SpanGap_r17) Decode(r *uper.UperReader) error {
	var err error
