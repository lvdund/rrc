...
type FeatureSetDownlink_v1700_mTRP_PDCCH_Case2_1SpanGap_r17 struct {
	Scs_15kHz_r17  *PDCCH_RepetitionParameters_r17 `optional`
	Scs_30kHz_r17  *PDCCH_RepetitionParameters_r17 `optional`
	Scs_60kHz_r17  *PDCCH_RepetitionParameters_r17 `optional`
	Scs_120kHz_r17 *PDCCH_RepetitionParameters_r17 `optional`
}

func (ie *FeatureSetDownlink_v1700_mTRP_PDCCH_Case2_1SpanGap_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *FeatureSetDownlink_v1700_mTRP_PDCCH_Case2_1SpanGap_r17) Decode(r *aper.AperReader) error {
	var err error
