...
func (ie *DRX_ConfigPTM_r17_drx_onDurationTimerPTM_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *DRX_ConfigPTM_r17_drx_onDurationTimerPTM_r17) Decode(r *aper.AperReader) error {
	var err error
