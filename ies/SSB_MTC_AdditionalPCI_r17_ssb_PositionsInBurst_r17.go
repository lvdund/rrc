...
func (ie *SSB_MTC_AdditionalPCI_r17_ssb_PositionsInBurst_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SSB_MTC_AdditionalPCI_r17_ssb_PositionsInBurst_r17) Decode(r *aper.AperReader) error {
	var err error
