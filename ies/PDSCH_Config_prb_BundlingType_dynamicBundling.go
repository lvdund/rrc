...
func (ie *PDSCH_Config_prb_BundlingType_dynamicBundling) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PDSCH_Config_prb_BundlingType_dynamicBundling) Decode(r *aper.AperReader) error {
	var err error
