...
func (ie *ULDedicatedMessageSegment_r16_IEs) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ULDedicatedMessageSegment_r16_IEs) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_SegmentNumber_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
