...
func (ie *SearchSpace_searchSpaceType_common_dci_Format2_0) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SearchSpace_searchSpaceType_common_dci_Format2_0) Decode(r *aper.AperReader) error {
	var err error
