...
func (ie *MeasResultListCLI_RSSI_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MeasResultCLI_RSSI_r16]([]*MeasResultCLI_RSSI_r16{}, aper.Constraint{Lb: 1, Ub: maxCLI_Report_r16}, false)
...
func (ie *MeasResultListCLI_RSSI_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MeasResultCLI_RSSI_r16]([]*MeasResultCLI_RSSI_r16{}, aper.Constraint{Lb: 1, Ub: maxCLI_Report_r16}, false)
