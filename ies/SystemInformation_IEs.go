...
type SystemInformation_IEs struct {
	Sib_TypeAndInfo          Sib_TypeAndInfoItem `madatory`
	LateNonCriticalExtension *[]byte             `optional`
	NonCriticalExtension     interface{}         `optional`
}

func (ie *SystemInformation_IEs) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SystemInformation_IEs) Decode(r *aper.AperReader) error {
	var err error
