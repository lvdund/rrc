...
func (ie *CSI_RS_Resource_Mobility_slotConfig) Encode(w *aper.AperWriter) error {
	var err error
	...
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms4:
		if err = w.WriteInteger(int64(ie.Ms4), &aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
			err = utils.WrapError("Encode Ms4", err)
		}
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms5:
		if err = w.WriteInteger(int64(ie.Ms5), &aper.Constraint{Lb: 0, Ub: 39}, false); err != nil {
			err = utils.WrapError("Encode Ms5", err)
		}
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms10:
		if err = w.WriteInteger(int64(ie.Ms10), &aper.Constraint{Lb: 0, Ub: 79}, false); err != nil {
			err = utils.WrapError("Encode Ms10", err)
		}
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms20:
		if err = w.WriteInteger(int64(ie.Ms20), &aper.Constraint{Lb: 0, Ub: 159}, false); err != nil {
			err = utils.WrapError("Encode Ms20", err)
		}
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms40:
		if err = w.WriteInteger(int64(ie.Ms40), &aper.Constraint{Lb: 0, Ub: 319}, false); err != nil {
...
func (ie *CSI_RS_Resource_Mobility_slotConfig) Decode(r *aper.AperReader) error {
	var err error
	...
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms4:
		...
		if tmp_int_Ms4, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
			return utils.WrapError("Decode Ms4", err)
		}
		ie.Ms4 = tmp_int_Ms4
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms5:
		var tmp_int_Ms5 int64
		if tmp_int_Ms5, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 39}, false); err != nil {
			return utils.WrapError("Decode Ms5", err)
		}
		ie.Ms5 = tmp_int_Ms5
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms10:
		var tmp_int_Ms10 int64
		if tmp_int_Ms10, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 79}, false); err != nil {
			return utils.WrapError("Decode Ms10", err)
		}
		ie.Ms10 = tmp_int_Ms10
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms20:
		var tmp_int_Ms20 int64
		if tmp_int_Ms20, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 159}, false); err != nil {
			return utils.WrapError("Decode Ms20", err)
		}
		ie.Ms20 = tmp_int_Ms20
	case CSI_RS_Resource_Mobility_slotConfig_Choice_Ms40:
		var tmp_int_Ms40 int64
		if tmp_int_Ms40, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 319}, false); err != nil {
