...
func (ie *MeasResultNR_measResult_rsIndexResults) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasResultNR_measResult_rsIndexResults) Decode(r *aper.AperReader) error {
	var err error
