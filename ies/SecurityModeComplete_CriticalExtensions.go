...
func (ie *SecurityModeComplete_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SecurityModeComplete_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
