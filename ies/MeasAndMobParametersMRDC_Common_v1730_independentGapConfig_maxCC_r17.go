...
func (ie *MeasAndMobParametersMRDC_Common_v1730_independentGapConfig_maxCC_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Fr1_Only_r17 != nil {
		if err = w.WriteInteger(*ie.Fr1_Only_r17, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
			return utils.WrapError("Encode Fr1_Only_r17", err)
		}
	}
	if ie.Fr2_Only_r17 != nil {
		if err = w.WriteInteger(*ie.Fr2_Only_r17, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
			return utils.WrapError("Encode Fr2_Only_r17", err)
		}
	}
	if ie.Fr1_AndFR2_r17 != nil {
		if err = w.WriteInteger(*ie.Fr1_AndFR2_r17, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
...
func (ie *MeasAndMobParametersMRDC_Common_v1730_independentGapConfig_maxCC_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if Fr1_Only_r17Present {
		...
		if tmp_int_Fr1_Only_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
	...
	if Fr2_Only_r17Present {
		...
		if tmp_int_Fr2_Only_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
	...
	if Fr1_AndFR2_r17Present {
		...
		if tmp_int_Fr1_AndFR2_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
