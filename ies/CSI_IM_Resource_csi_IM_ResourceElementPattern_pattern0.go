...
func (ie *CSI_IM_Resource_csi_IM_ResourceElementPattern_pattern0) Encode(w *aper.AperWriter) error {
	var err error
	if err = ie.SubcarrierLocation_p0.Encode(w); err != nil {
		return utils.WrapError("Encode SubcarrierLocation_p0", err)
	}
	if err = w.WriteInteger(ie.SymbolLocation_p0, &aper.Constraint{Lb: 0, Ub: 12}, false); err != nil {
		return utils.WrapError("WriteInteger SymbolLocation_p0", err)
	}
	return nil
}

func (ie *CSI_IM_Resource_csi_IM_ResourceElementPattern_pattern0) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_SymbolLocation_p0, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 12}, false); err != nil {
