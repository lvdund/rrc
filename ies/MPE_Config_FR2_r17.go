...
func (ie *MPE_Config_FR2_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.NumberOfN_r17, &aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
		return utils.WrapError("WriteInteger NumberOfN_r17", err)
	}
	return nil
}

func (ie *MPE_Config_FR2_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_NumberOfN_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
