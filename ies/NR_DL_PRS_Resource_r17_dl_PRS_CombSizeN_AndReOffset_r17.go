...
func (ie *NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	case NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17_Choice_N2_r17:
		if err = w.WriteInteger(int64(ie.N2_r17), &aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
	...
	case NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17_Choice_N6_r17:
		if err = w.WriteInteger(int64(ie.N6_r17), &aper.Constraint{Lb: 0, Ub: 5}, false); err != nil {
			err = utils.WrapError("Encode N6_r17", err)
		}
	case NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17_Choice_N12_r17:
		if err = w.WriteInteger(int64(ie.N12_r17), &aper.Constraint{Lb: 0, Ub: 11}, false); err != nil {
...
func (ie *NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	case NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17_Choice_N2_r17:
		...
		if tmp_int_N2_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
	...
	case NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17_Choice_N6_r17:
		...
		if tmp_int_N6_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 5}, false); err != nil {
			return utils.WrapError("Decode N6_r17", err)
		}
		ie.N6_r17 = tmp_int_N6_r17
	case NR_DL_PRS_Resource_r17_dl_PRS_CombSizeN_AndReOffset_r17_Choice_N12_r17:
		var tmp_int_N12_r17 int64
		if tmp_int_N12_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 11}, false); err != nil {
