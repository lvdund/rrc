...
func (ie *BandCombinationList_v15g0) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v15g0]([]*BandCombination_v15g0{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v15g0) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v15g0]([]*BandCombination_v15g0{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
