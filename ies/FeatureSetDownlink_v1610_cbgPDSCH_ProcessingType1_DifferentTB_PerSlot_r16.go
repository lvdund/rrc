...
type FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 struct {
	Scs_15kHz_r16  *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_15kHz_r16  `optional`
	Scs_30kHz_r16  *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_30kHz_r16  `optional`
	Scs_60kHz_r16  *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_60kHz_r16  `optional`
	Scs_120kHz_r16 *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_120kHz_r16 `optional`
}

func (ie *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16) Decode(r *uper.UperReader) error {
	var err error
	...
	if Scs_15kHz_r16Present {
		ie.Scs_15kHz_r16 = new(FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_15kHz_r16)
		if err = ie.Scs_15kHz_r16.Decode(r); err != nil {
			return utils.WrapError("Decode Scs_15kHz_r16", err)
		}
	}
	if Scs_30kHz_r16Present {
		ie.Scs_30kHz_r16 = new(FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_30kHz_r16)
		if err = ie.Scs_30kHz_r16.Decode(r); err != nil {
			return utils.WrapError("Decode Scs_30kHz_r16", err)
		}
	}
	if Scs_60kHz_r16Present {
		ie.Scs_60kHz_r16 = new(FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_60kHz_r16)
		if err = ie.Scs_60kHz_r16.Decode(r); err != nil {
			return utils.WrapError("Decode Scs_60kHz_r16", err)
		}
	}
	if Scs_120kHz_r16Present {
		ie.Scs_120kHz_r16 = new(FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_scs_120kHz_r16)
