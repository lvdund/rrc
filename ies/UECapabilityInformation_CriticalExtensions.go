...
func (ie *UECapabilityInformation_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UECapabilityInformation_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
