...
func (ie *SSB_MTC4_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.Pci_List_r17) > 0 {
		tmp_Pci_List_r17 := utils.NewSequence[*PhysCellId]([]*PhysCellId{}, aper.Constraint{Lb: 1, Ub: maxNrofPCIsPerSMTC}, false)
	...
	if err = w.WriteInteger(ie.Offset_r17, &aper.Constraint{Lb: 0, Ub: 159}, false); err != nil {
		return utils.WrapError("WriteInteger Offset_r17", err)
	}
	return nil
}

func (ie *SSB_MTC4_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_Offset_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 159}, false); err != nil {
