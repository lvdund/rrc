...
func (ie *FeatureSetDownlink_v1540_pdcch_MonitoringAnyOccasionsWithSpanGap) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *FeatureSetDownlink_v1540_pdcch_MonitoringAnyOccasionsWithSpanGap) Decode(r *aper.AperReader) error {
	var err error
