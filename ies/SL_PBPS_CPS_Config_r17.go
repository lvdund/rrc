...
func (ie *SL_PBPS_CPS_Config_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Sl_MinNumCandidateSlotsPeriodic_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_MinNumCandidateSlotsPeriodic_r17, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
			return utils.WrapError("Encode Sl_MinNumCandidateSlotsPeriodic_r17", err)
		}
	}
	if len(ie.Sl_PBPS_OccasionReservePeriodList_r17) > 0 {
		tmp_Sl_PBPS_OccasionReservePeriodList_r17 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: 16}, false)
		for _, i := range ie.Sl_PBPS_OccasionReservePeriodList_r17 {
			tmp_ie := utils.NewINTEGER(int64(i), aper.Constraint{Lb: 1, Ub: 16}, false)
	...
	if ie.Sl_CPS_WindowPeriodic_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_CPS_WindowPeriodic_r17, &aper.Constraint{Lb: 5, Ub: 30}, false); err != nil {
			return utils.WrapError("Encode Sl_CPS_WindowPeriodic_r17", err)
		}
	}
	if ie.Sl_MinNumCandidateSlotsAperiodic_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_MinNumCandidateSlotsAperiodic_r17, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
			return utils.WrapError("Encode Sl_MinNumCandidateSlotsAperiodic_r17", err)
		}
	}
	if ie.Sl_MinNumRssiMeasurementSlots_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_MinNumRssiMeasurementSlots_r17, &aper.Constraint{Lb: 1, Ub: 800}, false); err != nil {
			return utils.WrapError("Encode Sl_MinNumRssiMeasurementSlots_r17", err)
		}
	}
	if ie.Sl_DefaultCBR_RandomSelection_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_DefaultCBR_RandomSelection_r17, &aper.Constraint{Lb: 0, Ub: 100}, false); err != nil {
			return utils.WrapError("Encode Sl_DefaultCBR_RandomSelection_r17", err)
		}
	}
	if ie.Sl_DefaultCBR_PartialSensing_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_DefaultCBR_PartialSensing_r17, &aper.Constraint{Lb: 0, Ub: 100}, false); err != nil {
			return utils.WrapError("Encode Sl_DefaultCBR_PartialSensing_r17", err)
		}
	}
	if ie.Sl_CPS_WindowAperiodic_r17 != nil {
		if err = w.WriteInteger(*ie.Sl_CPS_WindowAperiodic_r17, &aper.Constraint{Lb: 0, Ub: 30}, false); err != nil {
...
func (ie *SL_PBPS_CPS_Config_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if Sl_MinNumCandidateSlotsPeriodic_r17Present {
		...
		if tmp_int_Sl_MinNumCandidateSlotsPeriodic_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
	...
	if Sl_PBPS_OccasionReservePeriodList_r17Present {
		...
		fn_Sl_PBPS_OccasionReservePeriodList_r17 := func() *utils.INTEGER {
			ie := utils.NewINTEGER(0, aper.Constraint{Lb: 1, Ub: 16}, false)
			return &ie
		}
	...
	if Sl_CPS_WindowPeriodic_r17Present {
		...
		if tmp_int_Sl_CPS_WindowPeriodic_r17, err = r.ReadInteger(&aper.Constraint{Lb: 5, Ub: 30}, false); err != nil {
	...
	if Sl_MinNumCandidateSlotsAperiodic_r17Present {
		...
		if tmp_int_Sl_MinNumCandidateSlotsAperiodic_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
	...
	if Sl_MinNumRssiMeasurementSlots_r17Present {
		...
		if tmp_int_Sl_MinNumRssiMeasurementSlots_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 800}, false); err != nil {
	...
	if Sl_DefaultCBR_RandomSelection_r17Present {
		...
		if tmp_int_Sl_DefaultCBR_RandomSelection_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 100}, false); err != nil {
	...
	if Sl_DefaultCBR_PartialSensing_r17Present {
		...
		if tmp_int_Sl_DefaultCBR_PartialSensing_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 100}, false); err != nil {
	...
	if Sl_CPS_WindowAperiodic_r17Present {
		...
		if tmp_int_Sl_CPS_WindowAperiodic_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 30}, false); err != nil {
