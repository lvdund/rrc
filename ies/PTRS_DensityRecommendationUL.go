...
func (ie *PTRS_DensityRecommendationUL) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.SampleDensity1, &aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
		return utils.WrapError("WriteInteger SampleDensity1", err)
	}
	if err = w.WriteInteger(ie.SampleDensity2, &aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
		return utils.WrapError("WriteInteger SampleDensity2", err)
	}
	if err = w.WriteInteger(ie.SampleDensity3, &aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
		return utils.WrapError("WriteInteger SampleDensity3", err)
	}
	if err = w.WriteInteger(ie.SampleDensity4, &aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
		return utils.WrapError("WriteInteger SampleDensity4", err)
	}
	if err = w.WriteInteger(ie.SampleDensity5, &aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
		return utils.WrapError("WriteInteger SampleDensity5", err)
	}
	return nil
}

func (ie *PTRS_DensityRecommendationUL) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_SampleDensity1, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
	...
	if tmp_int_SampleDensity2, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
	...
	if tmp_int_SampleDensity3, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
	...
	if tmp_int_SampleDensity4, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
	...
	if tmp_int_SampleDensity5, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 276}, false); err != nil {
