...
type UL_AccessConfigListDCI_0_1_r17 struct {
	Value []int64 `lb:1,ub:3,madatory`
}

func (ie *UL_AccessConfigListDCI_0_1_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: 3}, false)
...
func (ie *UL_AccessConfigListDCI_0_1_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: 3}, false)
