...
func (ie *SL_TxResourceReqList_v1700) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_TxResourceReq_v1700]([]*SL_TxResourceReq_v1700{}, aper.Constraint{Lb: 1, Ub: maxNrofSL_Dest_r16}, false)
...
func (ie *SL_TxResourceReqList_v1700) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_TxResourceReq_v1700]([]*SL_TxResourceReq_v1700{}, aper.Constraint{Lb: 1, Ub: maxNrofSL_Dest_r16}, false)
