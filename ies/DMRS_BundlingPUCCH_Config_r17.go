...
func (ie *DMRS_BundlingPUCCH_Config_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Pucch_TimeDomainWindowLength_r17 != nil {
		if err = w.WriteInteger(*ie.Pucch_TimeDomainWindowLength_r17, &aper.Constraint{Lb: 2, Ub: 8}, false); err != nil {
...
func (ie *DMRS_BundlingPUCCH_Config_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if Pucch_TimeDomainWindowLength_r17Present {
		...
		if tmp_int_Pucch_TimeDomainWindowLength_r17, err = r.ReadInteger(&aper.Constraint{Lb: 2, Ub: 8}, false); err != nil {
