...
type CodebookConfig_r16_codebookType_type2_subType_typeII_r16 struct {
	...
	TypeII_RI_Restriction_r16           aper.BitString                                                                               `lb:4,ub:4,madatory`
}

func (ie *CodebookConfig_r16_codebookType_type2_subType_typeII_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteBitString(ie.TypeII_RI_Restriction_r16.Bytes, uint(ie.TypeII_RI_Restriction_r16.NumBits), &aper.Constraint{Lb: 4, Ub: 4}, false); err != nil {
		return utils.WrapError("WriteBitString TypeII_RI_Restriction_r16", err)
	}
	return nil
}

func (ie *CodebookConfig_r16_codebookType_type2_subType_typeII_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_bs_TypeII_RI_Restriction_r16, n_TypeII_RI_Restriction_r16, err = r.ReadBitString(&aper.Constraint{Lb: 4, Ub: 4}, false); err != nil {
		return utils.WrapError("ReadBitString TypeII_RI_Restriction_r16", err)
	}
	ie.TypeII_RI_Restriction_r16 = aper.BitString{
