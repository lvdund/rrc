...
type RRCReconfigurationComplete struct {
	...
	CriticalExtensions        RRCReconfigurationComplete_CriticalExtensions `madatory`
}

func (ie *RRCReconfigurationComplete) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *RRCReconfigurationComplete) Decode(r *uper.UperReader) error {
	var err error
