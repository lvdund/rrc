...
func (ie *PagingRecordList) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*PagingRecord]([]*PagingRecord{}, aper.Constraint{Lb: 1, Ub: maxNrofPageRec}, false)
...
func (ie *PagingRecordList) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*PagingRecord]([]*PagingRecord{}, aper.Constraint{Lb: 1, Ub: maxNrofPageRec}, false)
