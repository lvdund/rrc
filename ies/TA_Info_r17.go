...
func (ie *TA_Info_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.Ta_Common_r17, &aper.Constraint{Lb: 0, Ub: 66485757}, false); err != nil {
		return utils.WrapError("WriteInteger Ta_Common_r17", err)
	}
	if ie.Ta_CommonDrift_r17 != nil {
		if err = w.WriteInteger(*ie.Ta_CommonDrift_r17, &aper.Constraint{Lb: -257303, Ub: 257303}, false); err != nil {
			return utils.WrapError("Encode Ta_CommonDrift_r17", err)
		}
	}
	if ie.Ta_CommonDriftVariant_r17 != nil {
		if err = w.WriteInteger(*ie.Ta_CommonDriftVariant_r17, &aper.Constraint{Lb: 0, Ub: 28949}, false); err != nil {
...
func (ie *TA_Info_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_Ta_Common_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 66485757}, false); err != nil {
	...
	if Ta_CommonDrift_r17Present {
		...
		if tmp_int_Ta_CommonDrift_r17, err = r.ReadInteger(&aper.Constraint{Lb: -257303, Ub: 257303}, false); err != nil {
	...
	if Ta_CommonDriftVariant_r17Present {
		...
		if tmp_int_Ta_CommonDriftVariant_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 28949}, false); err != nil {
