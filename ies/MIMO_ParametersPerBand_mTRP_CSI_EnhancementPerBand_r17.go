...
func (ie *MIMO_ParametersPerBand_mTRP_CSI_EnhancementPerBand_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.MaxNumNZP_CSI_RS_r17, &aper.Constraint{Lb: 2, Ub: 8}, false); err != nil {
	...
	tmp_SupportedComboAcrossCCs_r17 := utils.NewSequence[*CSI_MultiTRP_SupportedCombinations_r17]([]*CSI_MultiTRP_SupportedCombinations_r17{}, aper.Constraint{Lb: 1, Ub: 16}, false)
...
func (ie *MIMO_ParametersPerBand_mTRP_CSI_EnhancementPerBand_r17) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_MaxNumNZP_CSI_RS_r17 int64
	if tmp_int_MaxNumNZP_CSI_RS_r17, err = r.ReadInteger(&aper.Constraint{Lb: 2, Ub: 8}, false); err != nil {
