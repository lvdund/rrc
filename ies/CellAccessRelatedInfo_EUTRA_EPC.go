...
type CellAccessRelatedInfo_EUTRA_EPC struct {
	...
	TrackingAreaCode_eutra_epc  aper.BitString              `lb:16,ub:16,madatory`
	CellIdentity_eutra_epc      aper.BitString              `lb:28,ub:28,madatory`
}

func (ie *CellAccessRelatedInfo_EUTRA_EPC) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CellAccessRelatedInfo_EUTRA_EPC) Decode(r *aper.AperReader) error {
	var err error
	...
	ie.TrackingAreaCode_eutra_epc = aper.BitString{
	...
	ie.CellIdentity_eutra_epc = aper.BitString{
