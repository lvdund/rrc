...
type Fr2_r17 struct {
	...
	Scs_120kHz_r17 *uper.BitString `lb:16,ub:16,optional`
}

func (ie *Fr2_r17) Encode(w *uper.UperWriter) error {
	var err error
	...
	if ie.Scs_120kHz_r17 != nil {
		if err = w.WriteBitString(ie.Scs_120kHz_r17.Bytes, uint(ie.Scs_120kHz_r17.NumBits), &uper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
...
func (ie *Fr2_r17) Decode(r *uper.UperReader) error {
	var err error
	...
	if Scs_120kHz_r17Present {
		...
		if tmp_bs_Scs_120kHz_r17, n_Scs_120kHz_r17, err = r.ReadBitString(&uper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
