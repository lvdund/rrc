...
func (ie *MinSchedulingOffsetPreference_r16_preferredK0_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MinSchedulingOffsetPreference_r16_preferredK0_r16) Decode(r *aper.AperReader) error {
	var err error
