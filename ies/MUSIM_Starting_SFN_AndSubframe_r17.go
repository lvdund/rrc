...
func (ie *MUSIM_Starting_SFN_AndSubframe_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.Starting_SFN_r17, &aper.Constraint{Lb: 0, Ub: 1023}, false); err != nil {
		return utils.WrapError("WriteInteger Starting_SFN_r17", err)
	}
	if err = w.WriteInteger(ie.StartingSubframe_r17, &aper.Constraint{Lb: 0, Ub: 9}, false); err != nil {
		return utils.WrapError("WriteInteger StartingSubframe_r17", err)
	}
	return nil
}

func (ie *MUSIM_Starting_SFN_AndSubframe_r17) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_Starting_SFN_r17 int64
	if tmp_int_Starting_SFN_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 1023}, false); err != nil {
	...
	if tmp_int_StartingSubframe_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 9}, false); err != nil {
