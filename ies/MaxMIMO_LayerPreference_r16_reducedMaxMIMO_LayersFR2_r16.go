...
func (ie *MaxMIMO_LayerPreference_r16_reducedMaxMIMO_LayersFR2_r16) Encode(w *uper.UperWriter) error {
	var err error
	if err = w.WriteInteger(ie.ReducedMIMO_LayersFR2_DL_r16, &uper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
		return utils.WrapError("WriteInteger ReducedMIMO_LayersFR2_DL_r16", err)
	}
	if err = w.WriteInteger(ie.ReducedMIMO_LayersFR2_UL_r16, &uper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
		return utils.WrapError("WriteInteger ReducedMIMO_LayersFR2_UL_r16", err)
	}
	return nil
}

func (ie *MaxMIMO_LayerPreference_r16_reducedMaxMIMO_LayersFR2_r16) Decode(r *uper.UperReader) error {
	var err error
	var tmp_int_ReducedMIMO_LayersFR2_DL_r16 int64
	if tmp_int_ReducedMIMO_LayersFR2_DL_r16, err = r.ReadInteger(&uper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
	...
	if tmp_int_ReducedMIMO_LayersFR2_UL_r16, err = r.ReadInteger(&uper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
