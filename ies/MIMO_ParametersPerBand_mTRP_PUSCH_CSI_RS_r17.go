...
func (ie *MIMO_ParametersPerBand_mTRP_PUSCH_CSI_RS_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.MaxNumPeriodicSRS_r17, &aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
		return utils.WrapError("WriteInteger MaxNumPeriodicSRS_r17", err)
	}
	if err = w.WriteInteger(ie.MaxNumAperiodicSRS_r17, &aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
		return utils.WrapError("WriteInteger MaxNumAperiodicSRS_r17", err)
	}
	if err = w.WriteInteger(ie.MaxNumSP_SRS_r17, &aper.Constraint{Lb: 0, Ub: 8}, false); err != nil {
		return utils.WrapError("WriteInteger MaxNumSP_SRS_r17", err)
	}
	if err = w.WriteInteger(ie.NumSRS_ResourcePerCC_r17, &aper.Constraint{Lb: 1, Ub: 16}, false); err != nil {
		return utils.WrapError("WriteInteger NumSRS_ResourcePerCC_r17", err)
	}
	if err = w.WriteInteger(ie.NumSRS_ResourceNonCodebook_r17, &aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
		return utils.WrapError("WriteInteger NumSRS_ResourceNonCodebook_r17", err)
	}
	return nil
}

func (ie *MIMO_ParametersPerBand_mTRP_PUSCH_CSI_RS_r17) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_MaxNumPeriodicSRS_r17 int64
	if tmp_int_MaxNumPeriodicSRS_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
	...
	if tmp_int_MaxNumAperiodicSRS_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
	...
	if tmp_int_MaxNumSP_SRS_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 8}, false); err != nil {
	...
	if tmp_int_NumSRS_ResourcePerCC_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 16}, false); err != nil {
	...
	if tmp_int_NumSRS_ResourceNonCodebook_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
