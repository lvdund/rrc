...
func (ie *MIMO_ParametersPerBand_beamReportTiming_v1710) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MIMO_ParametersPerBand_beamReportTiming_v1710) Decode(r *aper.AperReader) error {
	var err error
