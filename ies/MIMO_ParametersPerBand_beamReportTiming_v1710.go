...
type MIMO_ParametersPerBand_beamReportTiming_v1710 struct {
	Scs_480kHz_r17 *MIMO_ParametersPerBand_beamReportTiming_v1710_scs_480kHz_r17 `optional`
	Scs_960kHz_r17 *MIMO_ParametersPerBand_beamReportTiming_v1710_scs_960kHz_r17 `optional`
}

func (ie *MIMO_ParametersPerBand_beamReportTiming_v1710) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *MIMO_ParametersPerBand_beamReportTiming_v1710) Decode(r *uper.UperReader) error {
	var err error
	...
	if Scs_480kHz_r17Present {
		ie.Scs_480kHz_r17 = new(MIMO_ParametersPerBand_beamReportTiming_v1710_scs_480kHz_r17)
		if err = ie.Scs_480kHz_r17.Decode(r); err != nil {
			return utils.WrapError("Decode Scs_480kHz_r17", err)
		}
	}
	if Scs_960kHz_r17Present {
		ie.Scs_960kHz_r17 = new(MIMO_ParametersPerBand_beamReportTiming_v1710_scs_960kHz_r17)
