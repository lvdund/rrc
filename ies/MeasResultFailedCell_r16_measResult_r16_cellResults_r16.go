...
func (ie *MeasResultFailedCell_r16_measResult_r16_cellResults_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasResultFailedCell_r16_measResult_r16_cellResults_r16) Decode(r *aper.AperReader) error {
	var err error
