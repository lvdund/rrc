...
func (ie *DLInformationTransferMRDC_r16_IEs) Encode(w *aper.AperWriter) error {
	...
	if ie.Dl_DCCH_MessageNR_r16 != nil {
		if err = w.WriteOctetString(*ie.Dl_DCCH_MessageNR_r16, &aper.Constraint{Lb: 0, Ub: 0}, false); err != nil {
			return utils.WrapError("Encode Dl_DCCH_MessageNR_r16", err)
		}
	}
	if ie.Dl_DCCH_MessageEUTRA_r16 != nil {
		if err = w.WriteOctetString(*ie.Dl_DCCH_MessageEUTRA_r16, &aper.Constraint{Lb: 0, Ub: 0}, false); err != nil {
...
func (ie *DLInformationTransferMRDC_r16_IEs) Decode(r *aper.AperReader) error {
	...
	if Dl_DCCH_MessageNR_r16Present {
		...
		if tmp_os_Dl_DCCH_MessageNR_r16, err = r.ReadOctetString(&aper.Constraint{Lb: 0, Ub: 0}, false); err != nil {
	...
	if Dl_DCCH_MessageEUTRA_r16Present {
		...
		if tmp_os_Dl_DCCH_MessageEUTRA_r16, err = r.ReadOctetString(&aper.Constraint{Lb: 0, Ub: 0}, false); err != nil {
