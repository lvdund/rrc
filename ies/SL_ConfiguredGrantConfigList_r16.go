...
func (ie *SL_ConfiguredGrantConfigList_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.Sl_ConfiguredGrantConfigToReleaseList_r16) > 0 {
		tmp_Sl_ConfiguredGrantConfigToReleaseList_r16 := utils.NewSequence[*SL_ConfigIndexCG_r16]([]*SL_ConfigIndexCG_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofCG_SL_r16}, false)
	...
	if len(ie.Sl_ConfiguredGrantConfigToAddModList_r16) > 0 {
		tmp_Sl_ConfiguredGrantConfigToAddModList_r16 := utils.NewSequence[*SL_ConfiguredGrantConfig_r16]([]*SL_ConfiguredGrantConfig_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofCG_SL_r16}, false)
...
func (ie *SL_ConfiguredGrantConfigList_r16) Decode(r *aper.AperReader) error {
	var err error
