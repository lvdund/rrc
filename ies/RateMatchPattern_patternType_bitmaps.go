...
type RateMatchPattern_patternType_bitmaps struct {
	ResourceBlocks         aper.BitString                                              `lb:275,ub:275,madatory`
...
func (ie *RateMatchPattern_patternType_bitmaps) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteBitString(ie.ResourceBlocks.Bytes, uint(ie.ResourceBlocks.NumBits), &aper.Constraint{Lb: 275, Ub: 275}, false); err != nil {
...
func (ie *RateMatchPattern_patternType_bitmaps) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_bs_ResourceBlocks, n_ResourceBlocks, err = r.ReadBitString(&aper.Constraint{Lb: 275, Ub: 275}, false); err != nil {
		return utils.WrapError("ReadBitString ResourceBlocks", err)
	}
	ie.ResourceBlocks = aper.BitString{
