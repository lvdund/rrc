...
func (ie *BandCombinationList_UplinkTxSwitch_v1630) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_UplinkTxSwitch_v1630]([]*BandCombination_UplinkTxSwitch_v1630{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_UplinkTxSwitch_v1630) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_UplinkTxSwitch_v1630]([]*BandCombination_UplinkTxSwitch_v1630{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
