...
func (ie *CSI_AssociatedReportConfigInfo_resourcesForChannel2_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	case CSI_AssociatedReportConfigInfo_resourcesForChannel2_r17_Choice_Csi_SSB_ResourceSet2_r17:
		if err = w.WriteInteger(int64(ie.Csi_SSB_ResourceSet2_r17), &aper.Constraint{Lb: 1, Ub: maxNrofCSI_SSB_ResourceSetsPerConfigExt}, false); err != nil {
...
func (ie *CSI_AssociatedReportConfigInfo_resourcesForChannel2_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	case CSI_AssociatedReportConfigInfo_resourcesForChannel2_r17_Choice_Csi_SSB_ResourceSet2_r17:
		...
		if tmp_int_Csi_SSB_ResourceSet2_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxNrofCSI_SSB_ResourceSetsPerConfigExt}, false); err != nil {
