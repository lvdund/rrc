...
func (ie *MobilityFromNRCommand_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MobilityFromNRCommand_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
