...
func (ie *UplinkTxSwitchingBandParameters_v1700) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.BandIndex_r17, &aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
...
func (ie *UplinkTxSwitchingBandParameters_v1700) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_BandIndex_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
