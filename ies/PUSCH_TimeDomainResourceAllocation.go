...
func (ie *PUSCH_TimeDomainResourceAllocation) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.K2 != nil {
		if err = w.WriteInteger(*ie.K2, &aper.Constraint{Lb: 0, Ub: 32}, false); err != nil {
...
func (ie *PUSCH_TimeDomainResourceAllocation) Decode(r *aper.AperReader) error {
	var err error
	var K2Present bool
	...
	if K2Present {
		...
		if tmp_int_K2, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 32}, false); err != nil {
