...
func (ie *PTRS_DownlinkConfig) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Epre_Ratio != nil {
		if err = w.WriteInteger(*ie.Epre_Ratio, &aper.Constraint{Lb: 0, Ub: 3}, false); err != nil {
...
func (ie *PTRS_DownlinkConfig) Decode(r *aper.AperReader) error {
	var err error
	...
	if Epre_RatioPresent {
		...
		if tmp_int_Epre_Ratio, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 3}, false); err != nil {
