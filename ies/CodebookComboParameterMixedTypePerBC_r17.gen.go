...
// Source: CodebookComboParameterMixedTypePerBC-r17 (line 18776).

var codebookComboParameterMixedTypePerBCR17Constraints = per.SequenceConstraints{
	Extensible: false,
...
var codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSNullR17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSM2R1NullR17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSM2R2NullR17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1SPType2FeType2PSM1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1SPType2FeType2PSM2R1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1SPEType2R1FeType2PSM1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1SPEType2R1FeType2PSM2R1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSNullR17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSM2R1NullR17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSM2R2NullR17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1MPType2FeType2PSM1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1MPType2FeType2PSM2R1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1MPEType2R1FeType2PSM1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

var codebookComboParameterMixedTypePerBCR17Type1MPEType2R1FeType2PSM2R1R17Constraints = per.SizeRange(1, common.MaxNrofCSI_RS_ResourcesExt_r16)

type CodebookComboParameterMixedTypePerBC_r17 struct {
...
func (ie *CodebookComboParameterMixedTypePerBC_r17) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(codebookComboParameterMixedTypePerBCR17Constraints)
	...
	// 2. type1SP-feType2PS-null-r17: sequence-of
	{
		if ie.Type1SP_FeType2PS_Null_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSNullR17Constraints)
	...
	// 3. type1SP-feType2PS-M2R1-null-r17: sequence-of
	{
		if ie.Type1SP_FeType2PS_M2R1_Null_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSM2R1NullR17Constraints)
	...
	// 4. type1SP-feType2PS-M2R2-null-r17: sequence-of
	{
		if ie.Type1SP_FeType2PS_M2R2_Null_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSM2R2NullR17Constraints)
	...
	// 5. type1SP-Type2-feType2-PS-M1-r17: sequence-of
	{
		if ie.Type1SP_Type2_FeType2_PS_M1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1SPType2FeType2PSM1R17Constraints)
	...
	// 6. type1SP-Type2-feType2-PS-M2R1-r17: sequence-of
	{
		if ie.Type1SP_Type2_FeType2_PS_M2R1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1SPType2FeType2PSM2R1R17Constraints)
	...
	// 7. type1SP-eType2R1-feType2-PS-M1-r17: sequence-of
	{
		if ie.Type1SP_EType2R1_FeType2_PS_M1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1SPEType2R1FeType2PSM1R17Constraints)
	...
	// 8. type1SP-eType2R1-feType2-PS-M2R1-r17: sequence-of
	{
		if ie.Type1SP_EType2R1_FeType2_PS_M2R1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1SPEType2R1FeType2PSM2R1R17Constraints)
	...
	// 9. type1MP-feType2PS-null-r17: sequence-of
	{
		if ie.Type1MP_FeType2PS_Null_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSNullR17Constraints)
	...
	// 10. type1MP-feType2PS-M2R1-null-r17: sequence-of
	{
		if ie.Type1MP_FeType2PS_M2R1_Null_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSM2R1NullR17Constraints)
	...
	// 11. type1MP-feType2PS-M2R2-null-r17: sequence-of
	{
		if ie.Type1MP_FeType2PS_M2R2_Null_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSM2R2NullR17Constraints)
	...
	// 12. type1MP-Type2-feType2-PS-M1-r17: sequence-of
	{
		if ie.Type1MP_Type2_FeType2_PS_M1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1MPType2FeType2PSM1R17Constraints)
	...
	// 13. type1MP-Type2-feType2-PS-M2R1-r17: sequence-of
	{
		if ie.Type1MP_Type2_FeType2_PS_M2R1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1MPType2FeType2PSM2R1R17Constraints)
	...
	// 14. type1MP-eType2R1-feType2-PS-M1-r17: sequence-of
	{
		if ie.Type1MP_EType2R1_FeType2_PS_M1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1MPEType2R1FeType2PSM1R17Constraints)
	...
	// 15. type1MP-eType2R1-feType2-PS-M2R1-r17: sequence-of
	{
		if ie.Type1MP_EType2R1_FeType2_PS_M2R1_r17 != nil {
			seqOf := e.NewSequenceOfEncoder(codebookComboParameterMixedTypePerBCR17Type1MPEType2R1FeType2PSM2R1R17Constraints)
...
func (ie *CodebookComboParameterMixedTypePerBC_r17) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(codebookComboParameterMixedTypePerBCR17Constraints)
	...
	// 2. type1SP-feType2PS-null-r17: sequence-of
	{
		if seq.IsComponentPresent(0) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSNullR17Constraints)
	...
	// 3. type1SP-feType2PS-M2R1-null-r17: sequence-of
	{
		if seq.IsComponentPresent(1) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSM2R1NullR17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 4. type1SP-feType2PS-M2R2-null-r17: sequence-of
	{
		if seq.IsComponentPresent(2) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1SPFeType2PSM2R2NullR17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 5. type1SP-Type2-feType2-PS-M1-r17: sequence-of
	{
		if seq.IsComponentPresent(3) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1SPType2FeType2PSM1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 6. type1SP-Type2-feType2-PS-M2R1-r17: sequence-of
	{
		if seq.IsComponentPresent(4) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1SPType2FeType2PSM2R1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 7. type1SP-eType2R1-feType2-PS-M1-r17: sequence-of
	{
		if seq.IsComponentPresent(5) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1SPEType2R1FeType2PSM1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 8. type1SP-eType2R1-feType2-PS-M2R1-r17: sequence-of
	{
		if seq.IsComponentPresent(6) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1SPEType2R1FeType2PSM2R1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 9. type1MP-feType2PS-null-r17: sequence-of
	{
		if seq.IsComponentPresent(7) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSNullR17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 10. type1MP-feType2PS-M2R1-null-r17: sequence-of
	{
		if seq.IsComponentPresent(8) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSM2R1NullR17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 11. type1MP-feType2PS-M2R2-null-r17: sequence-of
	{
		if seq.IsComponentPresent(9) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1MPFeType2PSM2R2NullR17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 12. type1MP-Type2-feType2-PS-M1-r17: sequence-of
	{
		if seq.IsComponentPresent(10) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1MPType2FeType2PSM1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 13. type1MP-Type2-feType2-PS-M2R1-r17: sequence-of
	{
		if seq.IsComponentPresent(11) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1MPType2FeType2PSM2R1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 14. type1MP-eType2R1-feType2-PS-M1-r17: sequence-of
	{
		if seq.IsComponentPresent(12) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1MPEType2R1FeType2PSM1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
	...
	// 15. type1MP-eType2R1-feType2-PS-M2R1-r17: sequence-of
	{
		if seq.IsComponentPresent(13) {
			seqOf := d.NewSequenceOfDecoder(codebookComboParameterMixedTypePerBCR17Type1MPEType2R1FeType2PSM2R1R17Constraints)
			n, err := seqOf.DecodeLength()
			if err != nil {
				return err
			}
