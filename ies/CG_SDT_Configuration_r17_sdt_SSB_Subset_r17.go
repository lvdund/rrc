...
type CG_SDT_Configuration_r17_sdt_SSB_Subset_r17 struct {
	Choice           uint64
	ShortBitmap_r17  aper.BitString `lb:4,ub:4,madatory`
	MediumBitmap_r17 aper.BitString `lb:8,ub:8,madatory`
	LongBitmap_r17   aper.BitString `lb:64,ub:64,madatory`
}

func (ie *CG_SDT_Configuration_r17_sdt_SSB_Subset_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	case CG_SDT_Configuration_r17_sdt_SSB_Subset_r17_Choice_ShortBitmap_r17:
		if err = w.WriteBitString(ie.ShortBitmap_r17.Bytes, uint(ie.ShortBitmap_r17.NumBits), &aper.Constraint{Lb: 4, Ub: 4}, false); err != nil {
			err = utils.WrapError("Encode ShortBitmap_r17", err)
		}
	case CG_SDT_Configuration_r17_sdt_SSB_Subset_r17_Choice_MediumBitmap_r17:
		if err = w.WriteBitString(ie.MediumBitmap_r17.Bytes, uint(ie.MediumBitmap_r17.NumBits), &aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			err = utils.WrapError("Encode MediumBitmap_r17", err)
		}
	case CG_SDT_Configuration_r17_sdt_SSB_Subset_r17_Choice_LongBitmap_r17:
		if err = w.WriteBitString(ie.LongBitmap_r17.Bytes, uint(ie.LongBitmap_r17.NumBits), &aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
...
func (ie *CG_SDT_Configuration_r17_sdt_SSB_Subset_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	case CG_SDT_Configuration_r17_sdt_SSB_Subset_r17_Choice_ShortBitmap_r17:
		...
		if tmp_bs_ShortBitmap_r17, n_ShortBitmap_r17, err = r.ReadBitString(&aper.Constraint{Lb: 4, Ub: 4}, false); err != nil {
			return utils.WrapError("Decode ShortBitmap_r17", err)
		}
		ie.ShortBitmap_r17 = aper.BitString{
	...
	case CG_SDT_Configuration_r17_sdt_SSB_Subset_r17_Choice_MediumBitmap_r17:
		...
		if tmp_bs_MediumBitmap_r17, n_MediumBitmap_r17, err = r.ReadBitString(&aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			return utils.WrapError("Decode MediumBitmap_r17", err)
		}
		ie.MediumBitmap_r17 = aper.BitString{
	...
	case CG_SDT_Configuration_r17_sdt_SSB_Subset_r17_Choice_LongBitmap_r17:
		...
		if tmp_bs_LongBitmap_r17, n_LongBitmap_r17, err = r.ReadBitString(&aper.Constraint{Lb: 64, Ub: 64}, false); err != nil {
			return utils.WrapError("Decode LongBitmap_r17", err)
		}
		ie.LongBitmap_r17 = aper.BitString{
