...
func (ie *CellAccessRelatedInfo) Encode(w *aper.AperWriter) error {
	var err error
	...
	if hasExtensions {
		...
		if extBitmap[1] {
			...
			if len(ie.Snpn_AccessInfoList_r17) > 0 {
				tmp_Snpn_AccessInfoList_r17 := utils.NewSequence[*SNPN_AccessInfo_r17]([]*SNPN_AccessInfo_r17{}, aper.Constraint{Lb: 1, Ub: maxNPN_r16}, false)
...
func (ie *CellAccessRelatedInfo) Decode(r *aper.AperReader) error {
	var err error
