...
func (ie *CrossCarrierSchedulingConfig_carrierIndicatorSize_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.CarrierIndicatorSizeDCI_1_2_r16, &aper.Constraint{Lb: 0, Ub: 3}, false); err != nil {
		return utils.WrapError("WriteInteger CarrierIndicatorSizeDCI_1_2_r16", err)
	}
	if err = w.WriteInteger(ie.CarrierIndicatorSizeDCI_0_2_r16, &aper.Constraint{Lb: 0, Ub: 3}, false); err != nil {
		return utils.WrapError("WriteInteger CarrierIndicatorSizeDCI_0_2_r16", err)
	}
	return nil
}

func (ie *CrossCarrierSchedulingConfig_carrierIndicatorSize_r16) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_CarrierIndicatorSizeDCI_1_2_r16 int64
	if tmp_int_CarrierIndicatorSizeDCI_1_2_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 3}, false); err != nil {
	...
	if tmp_int_CarrierIndicatorSizeDCI_0_2_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 3}, false); err != nil {
