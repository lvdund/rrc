...
func (ie *BT_NameList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BT_Name_r16]([]*BT_Name_r16{}, aper.Constraint{Lb: 1, Ub: maxBT_Name_r16}, false)
...
func (ie *BT_NameList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BT_Name_r16]([]*BT_Name_r16{}, aper.Constraint{Lb: 1, Ub: maxBT_Name_r16}, false)
	fn := func() *BT_Name_r16 {
