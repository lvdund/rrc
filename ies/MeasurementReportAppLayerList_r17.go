...
func (ie *MeasurementReportAppLayerList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MeasReportAppLayer_r17]([]*MeasReportAppLayer_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofAppLayerMeas_r17}, false)
...
func (ie *MeasurementReportAppLayerList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MeasReportAppLayer_r17]([]*MeasReportAppLayer_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofAppLayerMeas_r17}, false)
