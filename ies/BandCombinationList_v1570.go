...
func (ie *BandCombinationList_v1570) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1570]([]*BandCombination_v1570{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v1570) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1570]([]*BandCombination_v1570{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
