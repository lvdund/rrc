...
func (ie *BandCombinationList_v1580) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1580]([]*BandCombination_v1580{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v1580) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1580]([]*BandCombination_v1580{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
