...
func (ie *IABOtherInformation_r16_IEs_ip_InfoType_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *IABOtherInformation_r16_IEs_ip_InfoType_r16) Decode(r *uper.UperReader) error {
	var err error
