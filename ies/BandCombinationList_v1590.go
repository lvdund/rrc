...
func (ie *BandCombinationList_v1590) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1590]([]*BandCombination_v1590{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v1590) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1590]([]*BandCombination_v1590{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
