...
func (ie *UECapabilityInformationSidelink_v1700_IEs) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UECapabilityInformationSidelink_v1700_IEs) Decode(r *aper.AperReader) error {
	var err error
