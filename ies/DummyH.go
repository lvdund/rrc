...
func (ie *DummyH) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.BurstLength, &aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
	...
	if err = w.WriteInteger(ie.MaxConfiguredResourceSetsAllCC, &aper.Constraint{Lb: 1, Ub: 128}, false); err != nil {
		return utils.WrapError("WriteInteger MaxConfiguredResourceSetsAllCC", err)
	}
	return nil
}

func (ie *DummyH) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_BurstLength int64
	if tmp_int_BurstLength, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 2}, false); err != nil {
	...
	if tmp_int_MaxConfiguredResourceSetsAllCC, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 128}, false); err != nil {
