...
type Fr1_r16 struct {
	Scs_15kHz_r16 *aper.BitString `lb:16,ub:16,optional`
	Scs_30kHz_r16 *aper.BitString `lb:16,ub:16,optional`
	Scs_60kHz_r16 *aper.BitString `lb:16,ub:16,optional`
}

func (ie *Fr1_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Scs_15kHz_r16 != nil {
		if err = w.WriteBitString(ie.Scs_15kHz_r16.Bytes, uint(ie.Scs_15kHz_r16.NumBits), &aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
			return utils.WrapError("Encode Scs_15kHz_r16", err)
		}
	}
	if ie.Scs_30kHz_r16 != nil {
		if err = w.WriteBitString(ie.Scs_30kHz_r16.Bytes, uint(ie.Scs_30kHz_r16.NumBits), &aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
...
func (ie *Fr1_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if Scs_15kHz_r16Present {
		...
		if tmp_bs_Scs_15kHz_r16, n_Scs_15kHz_r16, err = r.ReadBitString(&aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
	...
	if Scs_30kHz_r16Present {
		...
		if tmp_bs_Scs_30kHz_r16, n_Scs_30kHz_r16, err = r.ReadBitString(&aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
