...
func (ie *BandCombinationList_v1690) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1690]([]*BandCombination_v1690{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v1690) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1690]([]*BandCombination_v1690{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
