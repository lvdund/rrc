...
func (ie *CrossCarrierSchedulingConfig_schedulingCellInfo) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CrossCarrierSchedulingConfig_schedulingCellInfo) Decode(r *aper.AperReader) error {
	var err error
