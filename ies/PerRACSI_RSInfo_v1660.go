...
func (ie *PerRACSI_RSInfo_v1660) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Csi_RS_Index_v1660 != nil {
		if err = w.WriteInteger(*ie.Csi_RS_Index_v1660, &aper.Constraint{Lb: 1, Ub: 96}, false); err != nil {
...
func (ie *PerRACSI_RSInfo_v1660) Decode(r *aper.AperReader) error {
	var err error
	...
	if Csi_RS_Index_v1660Present {
		...
		if tmp_int_Csi_RS_Index_v1660, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 96}, false); err != nil {
