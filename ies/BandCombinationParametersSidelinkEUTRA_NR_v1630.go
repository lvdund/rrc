...
func (ie *BandCombinationParametersSidelinkEUTRA_NR_v1630) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandParametersSidelinkEUTRA_NR_v1630]([]*BandParametersSidelinkEUTRA_NR_v1630{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
...
func (ie *BandCombinationParametersSidelinkEUTRA_NR_v1630) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandParametersSidelinkEUTRA_NR_v1630]([]*BandParametersSidelinkEUTRA_NR_v1630{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
