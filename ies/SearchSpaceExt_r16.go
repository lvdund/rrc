...
type SearchSpaceExt_r16 struct {
	...
	FreqMonitorLocations_r16   *aper.BitString                         `lb:5,ub:5,optional,ext`
}

func (ie *SearchSpaceExt_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SearchSpaceExt_r16) Decode(r *aper.AperReader) error {
	var err error
