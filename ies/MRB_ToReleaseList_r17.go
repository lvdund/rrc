...
func (ie *MRB_ToReleaseList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MRB_Identity_r17]([]*MRB_Identity_r17{}, aper.Constraint{Lb: 1, Ub: maxMRB_r17}, false)
...
func (ie *MRB_ToReleaseList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MRB_Identity_r17]([]*MRB_Identity_r17{}, aper.Constraint{Lb: 1, Ub: maxMRB_r17}, false)
