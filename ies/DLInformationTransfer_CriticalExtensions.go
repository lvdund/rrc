...
func (ie *DLInformationTransfer_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *DLInformationTransfer_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
