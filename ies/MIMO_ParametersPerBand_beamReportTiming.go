...
func (ie *MIMO_ParametersPerBand_beamReportTiming) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MIMO_ParametersPerBand_beamReportTiming) Decode(r *aper.AperReader) error {
	var err error
