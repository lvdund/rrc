...
func (ie *UL_DCCH_MessageType_MessageClassExtension) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UL_DCCH_MessageType_MessageClassExtension) Decode(r *aper.AperReader) error {
	var err error
