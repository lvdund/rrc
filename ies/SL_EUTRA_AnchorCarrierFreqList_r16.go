...
func (ie *SL_EUTRA_AnchorCarrierFreqList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*ARFCN_ValueEUTRA]([]*ARFCN_ValueEUTRA{}, aper.Constraint{Lb: 1, Ub: maxFreqSL_EUTRA_r16}, false)
...
func (ie *SL_EUTRA_AnchorCarrierFreqList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*ARFCN_ValueEUTRA]([]*ARFCN_ValueEUTRA{}, aper.Constraint{Lb: 1, Ub: maxFreqSL_EUTRA_r16}, false)
