...
func (ie *SL_EventTriggerConfig_r16_sl_EventId_r16_eventS2_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SL_EventTriggerConfig_r16_sl_EventId_r16_eventS2_r16) Decode(r *aper.AperReader) error {
	var err error
