...
func (ie *BandSidelink_r16_sl_TransmissionMode1_r16_scs_CP_PatternTxSidelinkModeOne_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *BandSidelink_r16_sl_TransmissionMode1_r16_scs_CP_PatternTxSidelinkModeOne_r16) Decode(r *uper.UperReader) error {
	var err error
