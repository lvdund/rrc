...
func (ie *CodebookVariantsList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SupportedCSI_RS_Resource]([]*SupportedCSI_RS_Resource{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesAlt_r16}, false)
...
func (ie *CodebookVariantsList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SupportedCSI_RS_Resource]([]*SupportedCSI_RS_Resource{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesAlt_r16}, false)
