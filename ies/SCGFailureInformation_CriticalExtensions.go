...
func (ie *SCGFailureInformation_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SCGFailureInformation_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
