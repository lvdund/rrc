...
func (ie *BetaOffsetsCrossPri_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 3, Ub: 3}, false)
...
func (ie *BetaOffsetsCrossPri_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 3, Ub: 3}, false)
