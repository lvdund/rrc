...
func (ie *PDSCH_Config_dl_OrJointTCI_StateList_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PDSCH_Config_dl_OrJointTCI_StateList_r17) Decode(r *aper.AperReader) error {
	var err error
