...
type ConfiguredGrantConfig_rrc_ConfiguredUplinkGrant struct {
	...
	FrequencyDomainAllocation          aper.BitString                                                                      `lb:18,ub:18,madatory`
...
func (ie *ConfiguredGrantConfig_rrc_ConfiguredUplinkGrant) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.TimeDomainOffset, &aper.Constraint{Lb: 0, Ub: 5119}, false); err != nil {
		return utils.WrapError("WriteInteger TimeDomainOffset", err)
	}
	if err = w.WriteInteger(ie.TimeDomainAllocation, &aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
		return utils.WrapError("WriteInteger TimeDomainAllocation", err)
	}
	if err = w.WriteBitString(ie.FrequencyDomainAllocation.Bytes, uint(ie.FrequencyDomainAllocation.NumBits), &aper.Constraint{Lb: 18, Ub: 18}, false); err != nil {
		return utils.WrapError("WriteBitString FrequencyDomainAllocation", err)
	}
	if err = w.WriteInteger(ie.AntennaPort, &aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
		return utils.WrapError("WriteInteger AntennaPort", err)
	}
	if ie.Dmrs_SeqInitialization != nil {
		if err = w.WriteInteger(*ie.Dmrs_SeqInitialization, &aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
			return utils.WrapError("Encode Dmrs_SeqInitialization", err)
		}
	}
	if err = w.WriteInteger(ie.PrecodingAndNumberOfLayers, &aper.Constraint{Lb: 0, Ub: 63}, false); err != nil {
		return utils.WrapError("WriteInteger PrecodingAndNumberOfLayers", err)
	}
	if ie.Srs_ResourceIndicator != nil {
		if err = w.WriteInteger(*ie.Srs_ResourceIndicator, &aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
			return utils.WrapError("Encode Srs_ResourceIndicator", err)
		}
	}
	if err = w.WriteInteger(ie.McsAndTBS, &aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
		return utils.WrapError("WriteInteger McsAndTBS", err)
	}
	if ie.FrequencyHoppingOffset != nil {
		if err = w.WriteInteger(*ie.FrequencyHoppingOffset, &aper.Constraint{Lb: 1, Ub: maxNrofPhysicalResourceBlocks_1}, false); err != nil {
			return utils.WrapError("Encode FrequencyHoppingOffset", err)
		}
	}
	if err = w.WriteInteger(ie.PathlossReferenceIndex, &aper.Constraint{Lb: 0, Ub: maxNrofPUSCH_PathlossReferenceRSs_1}, false); err != nil {
	...
	if ie.PathlossReferenceIndex2_r17 != nil {
		if err = w.WriteInteger(*ie.PathlossReferenceIndex2_r17, &aper.Constraint{Lb: 0, Ub: maxNrofPUSCH_PathlossReferenceRSs_1}, false); err != nil {
			return utils.WrapError("Encode PathlossReferenceIndex2_r17", err)
		}
	}
	if ie.Srs_ResourceIndicator2_r17 != nil {
		if err = w.WriteInteger(*ie.Srs_ResourceIndicator2_r17, &aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
			return utils.WrapError("Encode Srs_ResourceIndicator2_r17", err)
		}
	}
	if ie.PrecodingAndNumberOfLayers2_r17 != nil {
		if err = w.WriteInteger(*ie.PrecodingAndNumberOfLayers2_r17, &aper.Constraint{Lb: 0, Ub: 63}, false); err != nil {
			return utils.WrapError("Encode PrecodingAndNumberOfLayers2_r17", err)
		}
	}
	if ie.TimeDomainAllocation_v1710 != nil {
		if err = w.WriteInteger(*ie.TimeDomainAllocation_v1710, &aper.Constraint{Lb: 16, Ub: 63}, false); err != nil {
			return utils.WrapError("Encode TimeDomainAllocation_v1710", err)
		}
	}
	if ie.TimeDomainOffset_r17 != nil {
		if err = w.WriteInteger(*ie.TimeDomainOffset_r17, &aper.Constraint{Lb: 0, Ub: 40959}, false); err != nil {
...
func (ie *ConfiguredGrantConfig_rrc_ConfiguredUplinkGrant) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_TimeDomainOffset, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 5119}, false); err != nil {
	...
	if tmp_int_TimeDomainAllocation, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
	...
	if tmp_bs_FrequencyDomainAllocation, n_FrequencyDomainAllocation, err = r.ReadBitString(&aper.Constraint{Lb: 18, Ub: 18}, false); err != nil {
		return utils.WrapError("ReadBitString FrequencyDomainAllocation", err)
	}
	ie.FrequencyDomainAllocation = aper.BitString{
		Bytes:   tmp_bs_FrequencyDomainAllocation,
		NumBits: uint64(n_FrequencyDomainAllocation),
	}
	var tmp_int_AntennaPort int64
	if tmp_int_AntennaPort, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
	...
	if Dmrs_SeqInitializationPresent {
		...
		if tmp_int_Dmrs_SeqInitialization, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
	...
	if tmp_int_PrecodingAndNumberOfLayers, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 63}, false); err != nil {
	...
	if Srs_ResourceIndicatorPresent {
		...
		if tmp_int_Srs_ResourceIndicator, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
	...
	if tmp_int_McsAndTBS, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
	...
	if FrequencyHoppingOffsetPresent {
		...
		if tmp_int_FrequencyHoppingOffset, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxNrofPhysicalResourceBlocks_1}, false); err != nil {
	...
	if tmp_int_PathlossReferenceIndex, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: maxNrofPUSCH_PathlossReferenceRSs_1}, false); err != nil {
	...
	if PathlossReferenceIndex2_r17Present {
		...
		if tmp_int_PathlossReferenceIndex2_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: maxNrofPUSCH_PathlossReferenceRSs_1}, false); err != nil {
	...
	if Srs_ResourceIndicator2_r17Present {
		...
		if tmp_int_Srs_ResourceIndicator2_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
	...
	if PrecodingAndNumberOfLayers2_r17Present {
		...
		if tmp_int_PrecodingAndNumberOfLayers2_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 63}, false); err != nil {
	...
	if TimeDomainAllocation_v1710Present {
		...
		if tmp_int_TimeDomainAllocation_v1710, err = r.ReadInteger(&aper.Constraint{Lb: 16, Ub: 63}, false); err != nil {
	...
	if TimeDomainOffset_r17Present {
		...
		if tmp_int_TimeDomainOffset_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 40959}, false); err != nil {
