...
func (ie *SliceCellListNR_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*PCI_Range]([]*PCI_Range{}, aper.Constraint{Lb: 1, Ub: maxCellSlice_r17}, false)
...
func (ie *SliceCellListNR_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*PCI_Range]([]*PCI_Range{}, aper.Constraint{Lb: 1, Ub: maxCellSlice_r17}, false)
	fn := func() *PCI_Range {
