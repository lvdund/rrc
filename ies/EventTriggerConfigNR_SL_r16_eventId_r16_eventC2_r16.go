...
func (ie *EventTriggerConfigNR_SL_r16_eventId_r16_eventC2_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *EventTriggerConfigNR_SL_r16_eventId_r16_eventC2_r16) Decode(r *aper.AperReader) error {
	var err error
