...
func (ie *SRS_PosResourceSet_r16_pathlossReferenceRS_Pos_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SRS_PosResourceSet_r16_pathlossReferenceRS_Pos_r16) Decode(r *aper.AperReader) error {
	var err error
