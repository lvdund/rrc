...
func (ie *SubgroupConfig_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.SubgroupsNumPerPO_r17, &aper.Constraint{Lb: 1, Ub: maxNrofPagingSubgroups_r17}, false); err != nil {
		return utils.WrapError("WriteInteger SubgroupsNumPerPO_r17", err)
	}
	if ie.SubgroupsNumForUEID_r17 != nil {
		if err = w.WriteInteger(*ie.SubgroupsNumForUEID_r17, &aper.Constraint{Lb: 1, Ub: maxNrofPagingSubgroups_r17}, false); err != nil {
...
func (ie *SubgroupConfig_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_SubgroupsNumPerPO_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxNrofPagingSubgroups_r17}, false); err != nil {
	...
	if SubgroupsNumForUEID_r17Present {
		...
		if tmp_int_SubgroupsNumForUEID_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxNrofPagingSubgroups_r17}, false); err != nil {
