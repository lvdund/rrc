...
func (ie *SSB_MTC_periodicityAndOffset) Encode(w *aper.AperWriter) error {
	var err error
	...
	case SSB_MTC_periodicityAndOffset_Choice_Sf5:
		if err = w.WriteInteger(int64(ie.Sf5), &aper.Constraint{Lb: 0, Ub: 4}, false); err != nil {
			err = utils.WrapError("Encode Sf5", err)
		}
	case SSB_MTC_periodicityAndOffset_Choice_Sf10:
		if err = w.WriteInteger(int64(ie.Sf10), &aper.Constraint{Lb: 0, Ub: 9}, false); err != nil {
			err = utils.WrapError("Encode Sf10", err)
		}
	case SSB_MTC_periodicityAndOffset_Choice_Sf20:
		if err = w.WriteInteger(int64(ie.Sf20), &aper.Constraint{Lb: 0, Ub: 19}, false); err != nil {
			err = utils.WrapError("Encode Sf20", err)
		}
	case SSB_MTC_periodicityAndOffset_Choice_Sf40:
		if err = w.WriteInteger(int64(ie.Sf40), &aper.Constraint{Lb: 0, Ub: 39}, false); err != nil {
			err = utils.WrapError("Encode Sf40", err)
		}
	case SSB_MTC_periodicityAndOffset_Choice_Sf80:
		if err = w.WriteInteger(int64(ie.Sf80), &aper.Constraint{Lb: 0, Ub: 79}, false); err != nil {
			err = utils.WrapError("Encode Sf80", err)
		}
	case SSB_MTC_periodicityAndOffset_Choice_Sf160:
		if err = w.WriteInteger(int64(ie.Sf160), &aper.Constraint{Lb: 0, Ub: 159}, false); err != nil {
...
func (ie *SSB_MTC_periodicityAndOffset) Decode(r *aper.AperReader) error {
	var err error
	...
	case SSB_MTC_periodicityAndOffset_Choice_Sf5:
		...
		if tmp_int_Sf5, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 4}, false); err != nil {
			return utils.WrapError("Decode Sf5", err)
		}
		ie.Sf5 = tmp_int_Sf5
	case SSB_MTC_periodicityAndOffset_Choice_Sf10:
		var tmp_int_Sf10 int64
		if tmp_int_Sf10, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 9}, false); err != nil {
			return utils.WrapError("Decode Sf10", err)
		}
		ie.Sf10 = tmp_int_Sf10
	case SSB_MTC_periodicityAndOffset_Choice_Sf20:
		var tmp_int_Sf20 int64
		if tmp_int_Sf20, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 19}, false); err != nil {
			return utils.WrapError("Decode Sf20", err)
		}
		ie.Sf20 = tmp_int_Sf20
	case SSB_MTC_periodicityAndOffset_Choice_Sf40:
		var tmp_int_Sf40 int64
		if tmp_int_Sf40, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 39}, false); err != nil {
			return utils.WrapError("Decode Sf40", err)
		}
		ie.Sf40 = tmp_int_Sf40
	case SSB_MTC_periodicityAndOffset_Choice_Sf80:
		var tmp_int_Sf80 int64
		if tmp_int_Sf80, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 79}, false); err != nil {
			return utils.WrapError("Decode Sf80", err)
		}
		ie.Sf80 = tmp_int_Sf80
	case SSB_MTC_periodicityAndOffset_Choice_Sf160:
		var tmp_int_Sf160 int64
		if tmp_int_Sf160, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 159}, false); err != nil {
