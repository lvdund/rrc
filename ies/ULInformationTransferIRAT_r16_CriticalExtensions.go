...
func (ie *ULInformationTransferIRAT_r16_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ULInformationTransferIRAT_r16_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
