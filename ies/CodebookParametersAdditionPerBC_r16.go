...
func (ie *CodebookParametersAdditionPerBC_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.Etype2R1_r16) > 0 {
		tmp_Etype2R1_r16 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesExt_r16}, false)
	...
	if len(ie.Etype2R2_r16) > 0 {
		tmp_Etype2R2_r16 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesExt_r16}, false)
	...
	if len(ie.Etype2R1_PortSelection_r16) > 0 {
		tmp_Etype2R1_PortSelection_r16 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesExt_r16}, false)
	...
	if len(ie.Etype2R2_PortSelection_r16) > 0 {
		tmp_Etype2R2_PortSelection_r16 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesExt_r16}, false)
...
func (ie *CodebookParametersAdditionPerBC_r16) Decode(r *aper.AperReader) error {
	var err error
