...
// Source: UplinkConfigCommonSIB-v1700 (line 16318).

var uplinkConfigCommonSIBV1700Constraints = per.SequenceConstraints{
	Extensible: false,
...
func (ie *UplinkConfigCommonSIB_v1700) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(uplinkConfigCommonSIBV1700Constraints)
...
func (ie *UplinkConfigCommonSIB_v1700) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(uplinkConfigCommonSIBV1700Constraints)
