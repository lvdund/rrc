...
func (ie *CodebookConfig_codebookType_type2_subType_typeII_n1_n2_codebookSubsetRestriction) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CodebookConfig_codebookType_type2_subType_typeII_n1_n2_codebookSubsetRestriction) Decode(r *aper.AperReader) error {
	var err error
