...
type CodebookConfig_codebookType_type1_subType_typeI_SinglePanel_nrOfAntennaPorts_moreThanTwo struct {
	...
	TypeI_SinglePanel_codebookSubsetRestriction_i2 *aper.BitString                                                                                `lb:16,ub:16,optional`
}

func (ie *CodebookConfig_codebookType_type1_subType_typeI_SinglePanel_nrOfAntennaPorts_moreThanTwo) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.TypeI_SinglePanel_codebookSubsetRestriction_i2 != nil {
		if err = w.WriteBitString(ie.TypeI_SinglePanel_codebookSubsetRestriction_i2.Bytes, uint(ie.TypeI_SinglePanel_codebookSubsetRestriction_i2.NumBits), &aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
...
func (ie *CodebookConfig_codebookType_type1_subType_typeI_SinglePanel_nrOfAntennaPorts_moreThanTwo) Decode(r *aper.AperReader) error {
	var err error
	...
	if TypeI_SinglePanel_codebookSubsetRestriction_i2Present {
		...
		if tmp_bs_TypeI_SinglePanel_codebookSubsetRestriction_i2, n_TypeI_SinglePanel_codebookSubsetRestriction_i2, err = r.ReadBitString(&aper.Constraint{Lb: 16, Ub: 16}, false); err != nil {
