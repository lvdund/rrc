...
const (
	RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16_Choice_nothing uint64 = iota
	RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16_Choice_CellGlobalId_r16
	RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16_Choice_Pci_arfcn_r16
)

type RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16 struct {
	Choice           uint64
...
func (ie *RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16) Encode(w *aper.AperWriter) error {
	...
	switch ie.Choice {
	case RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16_Choice_CellGlobalId_r16:
		if err = ie.CellGlobalId_r16.Encode(w); err != nil {
			err = utils.WrapError("Encode CellGlobalId_r16", err)
		}
	case RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16_Choice_Pci_arfcn_r16:
...
func (ie *RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16) Decode(r *aper.AperReader) error {
	...
	switch ie.Choice {
	case RLF_Report_r16_nr_RLF_Report_r16_failedPCellId_r16_eutraFailedPCellId_r16_Choice_CellGlobalId_r16:
		ie.CellGlobalId_r16 = new(CGI_InfoEUTRALogging)
