...
func (ie *SL_TxPercentageList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_TxPercentageConfig_r16]([]*SL_TxPercentageConfig_r16{}, aper.Constraint{Lb: 8, Ub: 8}, false)
...
func (ie *SL_TxPercentageList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_TxPercentageConfig_r16]([]*SL_TxPercentageConfig_r16{}, aper.Constraint{Lb: 8, Ub: 8}, false)
