...
func (ie *RRCReconfigurationComplete_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RRCReconfigurationComplete_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
