...
type BandNR_channelBWs_UL_v1590_fr2 struct {
	Scs_60kHz  *aper.BitString `lb:8,ub:8,optional`
	Scs_120kHz *aper.BitString `lb:8,ub:8,optional`
}

func (ie *BandNR_channelBWs_UL_v1590_fr2) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.Scs_60kHz != nil {
		if err = w.WriteBitString(ie.Scs_60kHz.Bytes, uint(ie.Scs_60kHz.NumBits), &aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			return utils.WrapError("Encode Scs_60kHz", err)
		}
	}
	if ie.Scs_120kHz != nil {
		if err = w.WriteBitString(ie.Scs_120kHz.Bytes, uint(ie.Scs_120kHz.NumBits), &aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
...
func (ie *BandNR_channelBWs_UL_v1590_fr2) Decode(r *aper.AperReader) error {
	var err error
	...
	if Scs_60kHzPresent {
		...
		if tmp_bs_Scs_60kHz, n_Scs_60kHz, err = r.ReadBitString(&aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
	...
	if Scs_120kHzPresent {
		...
		if tmp_bs_Scs_120kHz, n_Scs_120kHz, err = r.ReadBitString(&aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
