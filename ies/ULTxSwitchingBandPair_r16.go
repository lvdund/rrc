...
type ULTxSwitchingBandPair_r16 struct {
	...
	UplinkTxSwitching_DL_Interruption_r16 *aper.BitString                                       `lb:1,ub:maxSimultaneousBands,optional`
}

func (ie *ULTxSwitchingBandPair_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.BandIndexUL1_r16, &aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
		return utils.WrapError("WriteInteger BandIndexUL1_r16", err)
	}
	if err = w.WriteInteger(ie.BandIndexUL2_r16, &aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
	...
	if ie.UplinkTxSwitching_DL_Interruption_r16 != nil {
		if err = w.WriteBitString(ie.UplinkTxSwitching_DL_Interruption_r16.Bytes, uint(ie.UplinkTxSwitching_DL_Interruption_r16.NumBits), &aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
...
func (ie *ULTxSwitchingBandPair_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_BandIndexUL1_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
	...
	if tmp_int_BandIndexUL2_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
	...
	if UplinkTxSwitching_DL_Interruption_r16Present {
		...
		if tmp_bs_UplinkTxSwitching_DL_Interruption_r16, n_UplinkTxSwitching_DL_Interruption_r16, err = r.ReadBitString(&aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false); err != nil {
