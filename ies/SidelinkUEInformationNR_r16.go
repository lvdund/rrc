...
type SidelinkUEInformationNR_r16 struct {
	CriticalExtensions SidelinkUEInformationNR_r16_CriticalExtensions `madatory`
}

func (ie *SidelinkUEInformationNR_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *SidelinkUEInformationNR_r16) Decode(r *uper.UperReader) error {
	var err error
