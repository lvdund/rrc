...
func (ie *HandoverCommand_CriticalExtensions_C1) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *HandoverCommand_CriticalExtensions_C1) Decode(r *aper.AperReader) error {
	var err error
