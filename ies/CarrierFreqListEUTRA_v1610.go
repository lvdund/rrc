...
func (ie *CarrierFreqListEUTRA_v1610) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*CarrierFreqEUTRA_v1610]([]*CarrierFreqEUTRA_v1610{}, aper.Constraint{Lb: 1, Ub: maxEUTRA_Carrier}, false)
...
func (ie *CarrierFreqListEUTRA_v1610) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*CarrierFreqEUTRA_v1610]([]*CarrierFreqEUTRA_v1610{}, aper.Constraint{Lb: 1, Ub: maxEUTRA_Carrier}, false)
