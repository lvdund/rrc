...
func (ie *UEAssistanceInformation_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UEAssistanceInformation_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
