...
func (ie *PDCCH_BlindDetectionCG_UE_MixedExt_r16) Encode(w *uper.UperWriter) error {
	var err error
	if err = w.WriteInteger(ie.Pdcch_BlindDetectionCG_UE1_r16, &uper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
		return utils.WrapError("WriteInteger Pdcch_BlindDetectionCG_UE1_r16", err)
	}
	if err = w.WriteInteger(ie.Pdcch_BlindDetectionCG_UE2_r16, &uper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
		return utils.WrapError("WriteInteger Pdcch_BlindDetectionCG_UE2_r16", err)
	}
	return nil
}

func (ie *PDCCH_BlindDetectionCG_UE_MixedExt_r16) Decode(r *uper.UperReader) error {
	var err error
	var tmp_int_Pdcch_BlindDetectionCG_UE1_r16 int64
	if tmp_int_Pdcch_BlindDetectionCG_UE1_r16, err = r.ReadInteger(&uper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
	...
	if tmp_int_Pdcch_BlindDetectionCG_UE2_r16, err = r.ReadInteger(&uper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
