...
func (ie *BandParameters_v1610_srs_TxSwitch_v1610) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *BandParameters_v1610_srs_TxSwitch_v1610) Decode(r *aper.AperReader) error {
	var err error
