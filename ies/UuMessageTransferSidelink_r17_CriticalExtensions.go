...
func (ie *UuMessageTransferSidelink_r17_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UuMessageTransferSidelink_r17_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
