...
func (ie *BandCombinationListSidelinkEUTRA_NR_v1630) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombinationParametersSidelinkEUTRA_NR_v1630]([]*BandCombinationParametersSidelinkEUTRA_NR_v1630{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationListSidelinkEUTRA_NR_v1630) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombinationParametersSidelinkEUTRA_NR_v1630]([]*BandCombinationParametersSidelinkEUTRA_NR_v1630{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
