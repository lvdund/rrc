...
func (ie *MAC_ParametersFRX_Diff_r16_drx_Adaptation_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *MAC_ParametersFRX_Diff_r16_drx_Adaptation_r16) Decode(r *uper.UperReader) error {
	var err error
