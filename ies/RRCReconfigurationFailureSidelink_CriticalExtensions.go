...
func (ie *RRCReconfigurationFailureSidelink_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RRCReconfigurationFailureSidelink_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
