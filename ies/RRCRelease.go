...
type RRCRelease struct {
	...
	CriticalExtensions        RRCRelease_CriticalExtensions `madatory`
}

func (ie *RRCRelease) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *RRCRelease) Decode(r *uper.UperReader) error {
	var err error
