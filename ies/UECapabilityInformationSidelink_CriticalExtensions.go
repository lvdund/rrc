...
func (ie *UECapabilityInformationSidelink_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UECapabilityInformationSidelink_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
