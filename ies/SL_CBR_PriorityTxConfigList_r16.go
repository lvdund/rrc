...
func (ie *SL_CBR_PriorityTxConfigList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_PriorityTxConfigIndex_r16]([]*SL_PriorityTxConfigIndex_r16{}, aper.Constraint{Lb: 1, Ub: 8}, false)
...
func (ie *SL_CBR_PriorityTxConfigList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_PriorityTxConfigIndex_r16]([]*SL_PriorityTxConfigIndex_r16{}, aper.Constraint{Lb: 1, Ub: 8}, false)
