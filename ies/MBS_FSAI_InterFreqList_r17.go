...
func (ie *MBS_FSAI_InterFreqList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MBS_FSAI_InterFreq_r17]([]*MBS_FSAI_InterFreq_r17{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
...
func (ie *MBS_FSAI_InterFreqList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MBS_FSAI_InterFreq_r17]([]*MBS_FSAI_InterFreq_r17{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
