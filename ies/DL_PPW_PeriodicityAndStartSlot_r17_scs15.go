...
func (ie *DL_PPW_PeriodicityAndStartSlot_r17_scs15) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *DL_PPW_PeriodicityAndStartSlot_r17_scs15) Decode(r *aper.AperReader) error {
	var err error
	...
	case DL_PPW_PeriodicityAndStartSlot_r17_scs15_Choice_N4:
		...
		if tmp_int_N4, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 3}, false); err != nil {
			return utils.WrapError("Decode N4", err)
		}
		ie.N4 = tmp_int_N4
	case DL_PPW_PeriodicityAndStartSlot_r17_scs15_Choice_N5:
		var tmp_int_N5 int64
		if tmp_int_N5, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 4}, false); err != nil {
			return utils.WrapError("Decode N5", err)
		}
		ie.N5 = tmp_int_N5
	case DL_PPW_PeriodicityAndStartSlot_r17_scs15_Choice_N8:
		var tmp_int_N8 int64
		if tmp_int_N8, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 7}, false); err != nil {
			return utils.WrapError("Decode N8", err)
		}
		ie.N8 = tmp_int_N8
	case DL_PPW_PeriodicityAndStartSlot_r17_scs15_Choice_N10:
		var tmp_int_N10 int64
		if tmp_int_N10, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 9}, false); err != nil {
			return utils.WrapError("Decode N10", err)
		}
		ie.N10 = tmp_int_N10
	case DL_PPW_PeriodicityAndStartSlot_r17_scs15_Choice_N16:
		var tmp_int_N16 int64
		if tmp_int_N16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 15}, false); err != nil {
			return utils.WrapError("Decode N16", err)
		}
		ie.N16 = tmp_int_N16
	case DL_PPW_PeriodicityAndStartSlot_r17_scs15_Choice_N20:
		var tmp_int_N20 int64
		if tmp_int_N20, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 19}, false); err != nil {
