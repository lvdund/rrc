...
func (ie *PUSCH_Config_frequencyHoppingDCI_0_2_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PUSCH_Config_frequencyHoppingDCI_0_2_r16) Decode(r *aper.AperReader) error {
	var err error
