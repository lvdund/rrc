...
func (ie *InterFreqNeighCellList_v1610) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*InterFreqNeighCellInfo_v1610]([]*InterFreqNeighCellInfo_v1610{}, aper.Constraint{Lb: 1, Ub: maxCellInter}, false)
...
func (ie *InterFreqNeighCellList_v1610) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*InterFreqNeighCellInfo_v1610]([]*InterFreqNeighCellInfo_v1610{}, aper.Constraint{Lb: 1, Ub: maxCellInter}, false)
