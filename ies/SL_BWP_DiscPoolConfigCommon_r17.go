...
func (ie *SL_BWP_DiscPoolConfigCommon_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.Sl_DiscTxPoolSelected_r17) > 0 {
		tmp_Sl_DiscTxPoolSelected_r17 := utils.NewSequence[*SL_ResourcePoolConfig_r16]([]*SL_ResourcePoolConfig_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofTXPool_r16}, false)
...
func (ie *SL_BWP_DiscPoolConfigCommon_r17) Decode(r *aper.AperReader) error {
	var err error
