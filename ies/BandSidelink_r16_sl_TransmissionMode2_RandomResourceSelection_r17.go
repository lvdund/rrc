...
func (ie *BandSidelink_r16_sl_TransmissionMode2_RandomResourceSelection_r17) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *BandSidelink_r16_sl_TransmissionMode2_RandomResourceSelection_r17) Decode(r *uper.UperReader) error {
	var err error
