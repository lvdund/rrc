...
func (ie *SSB_MTC4List_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SSB_MTC4_r17]([]*SSB_MTC4_r17{}, aper.Constraint{Lb: 1, Ub: 3}, false)
...
func (ie *SSB_MTC4List_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SSB_MTC4_r17]([]*SSB_MTC4_r17{}, aper.Constraint{Lb: 1, Ub: 3}, false)
