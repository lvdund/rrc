...
func (ie *SL_TxProfileList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_TxProfile_r17]([]*SL_TxProfile_r17{}, aper.Constraint{Lb: 1, Ub: 256}, false)
...
func (ie *SL_TxProfileList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_TxProfile_r17]([]*SL_TxProfile_r17{}, aper.Constraint{Lb: 1, Ub: 256}, false)
