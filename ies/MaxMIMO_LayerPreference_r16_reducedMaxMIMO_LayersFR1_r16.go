...
func (ie *MaxMIMO_LayerPreference_r16_reducedMaxMIMO_LayersFR1_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.ReducedMIMO_LayersFR1_DL_r16, &aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
		return utils.WrapError("WriteInteger ReducedMIMO_LayersFR1_DL_r16", err)
	}
	if err = w.WriteInteger(ie.ReducedMIMO_LayersFR1_UL_r16, &aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
		return utils.WrapError("WriteInteger ReducedMIMO_LayersFR1_UL_r16", err)
	}
	return nil
}

func (ie *MaxMIMO_LayerPreference_r16_reducedMaxMIMO_LayersFR1_r16) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_ReducedMIMO_LayersFR1_DL_r16 int64
	if tmp_int_ReducedMIMO_LayersFR1_DL_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
	...
	if tmp_int_ReducedMIMO_LayersFR1_UL_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
