...
func (ie *InterFreqCarrierFreqList_v1700) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*InterFreqCarrierFreqInfo_v1700]([]*InterFreqCarrierFreqInfo_v1700{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
...
func (ie *InterFreqCarrierFreqList_v1700) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*InterFreqCarrierFreqInfo_v1700]([]*InterFreqCarrierFreqInfo_v1700{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
