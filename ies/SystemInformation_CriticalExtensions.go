...
func (ie *SystemInformation_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SystemInformation_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
