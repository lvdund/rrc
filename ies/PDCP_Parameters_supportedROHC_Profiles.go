...
type PDCP_Parameters_supportedROHC_Profiles struct {
	Profile0x0000 bool `madatory`
...
func (ie *PDCP_Parameters_supportedROHC_Profiles) Decode(r *aper.AperReader) error {
	...
	if tmp_bool_Profile0x0000, err = r.ReadBoolean(); err != nil {
		return utils.WrapError("ReadBoolean Profile0x0000", err)
	}
	ie.Profile0x0000 = tmp_bool_Profile0x0000
