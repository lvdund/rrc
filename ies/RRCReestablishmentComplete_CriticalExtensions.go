...
func (ie *RRCReestablishmentComplete_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RRCReestablishmentComplete_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
