...
func (ie *UL_PDCP_ExcessDelayResultList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*UL_PDCP_ExcessDelayResult_r17]([]*UL_PDCP_ExcessDelayResult_r17{}, aper.Constraint{Lb: 1, Ub: maxDRB}, false)
...
func (ie *UL_PDCP_ExcessDelayResultList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*UL_PDCP_ExcessDelayResult_r17]([]*UL_PDCP_ExcessDelayResult_r17{}, aper.Constraint{Lb: 1, Ub: maxDRB}, false)
