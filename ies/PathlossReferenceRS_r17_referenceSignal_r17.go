...
func (ie *PathlossReferenceRS_r17_referenceSignal_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PathlossReferenceRS_r17_referenceSignal_r17) Decode(r *aper.AperReader) error {
	var err error
