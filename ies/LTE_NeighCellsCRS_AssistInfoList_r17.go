...
func (ie *LTE_NeighCellsCRS_AssistInfoList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*LTE_NeighCellsCRS_AssistInfo_r17]([]*LTE_NeighCellsCRS_AssistInfo_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofCRS_IM_InterfCell_r17}, false)
...
func (ie *LTE_NeighCellsCRS_AssistInfoList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*LTE_NeighCellsCRS_AssistInfo_r17]([]*LTE_NeighCellsCRS_AssistInfo_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofCRS_IM_InterfCell_r17}, false)
