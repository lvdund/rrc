...
func (ie *HandoverPreparationInformation_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *HandoverPreparationInformation_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
