...
func (ie *MIMO_ParametersPerBand_mpe_Mitigation_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.MaxNumP_MPR_RI_pairs_r17, &aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
...
func (ie *MIMO_ParametersPerBand_mpe_Mitigation_r17) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_MaxNumP_MPR_RI_pairs_r17 int64
	if tmp_int_MaxNumP_MPR_RI_pairs_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
