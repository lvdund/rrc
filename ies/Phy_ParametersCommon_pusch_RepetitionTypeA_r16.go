...
func (ie *Phy_ParametersCommon_pusch_RepetitionTypeA_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *Phy_ParametersCommon_pusch_RepetitionTypeA_r16) Decode(r *aper.AperReader) error {
	var err error
