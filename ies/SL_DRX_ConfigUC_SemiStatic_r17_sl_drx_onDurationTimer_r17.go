...
func (ie *SL_DRX_ConfigUC_SemiStatic_r17_sl_drx_onDurationTimer_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SL_DRX_ConfigUC_SemiStatic_r17_sl_drx_onDurationTimer_r17) Decode(r *aper.AperReader) error {
	var err error
