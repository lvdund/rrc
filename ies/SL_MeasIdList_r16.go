...
func (ie *SL_MeasIdList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_MeasIdInfo_r16]([]*SL_MeasIdInfo_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofSL_MeasId_r16}, false)
...
func (ie *SL_MeasIdList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_MeasIdInfo_r16]([]*SL_MeasIdInfo_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofSL_MeasId_r16}, false)
