...
func (ie *CSI_RS_Resource_Mobility_frequencyDomainAllocation) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CSI_RS_Resource_Mobility_frequencyDomainAllocation) Decode(r *aper.AperReader) error {
	var err error
