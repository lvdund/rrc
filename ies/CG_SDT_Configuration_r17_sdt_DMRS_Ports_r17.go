...
type CG_SDT_Configuration_r17_sdt_DMRS_Ports_r17 struct {
	Choice        uint64
	DmrsType1_r17 aper.BitString `lb:8,ub:8,madatory`
	DmrsType2_r17 aper.BitString `lb:12,ub:12,madatory`
}

func (ie *CG_SDT_Configuration_r17_sdt_DMRS_Ports_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	case CG_SDT_Configuration_r17_sdt_DMRS_Ports_r17_Choice_DmrsType1_r17:
		if err = w.WriteBitString(ie.DmrsType1_r17.Bytes, uint(ie.DmrsType1_r17.NumBits), &aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			err = utils.WrapError("Encode DmrsType1_r17", err)
		}
	case CG_SDT_Configuration_r17_sdt_DMRS_Ports_r17_Choice_DmrsType2_r17:
		if err = w.WriteBitString(ie.DmrsType2_r17.Bytes, uint(ie.DmrsType2_r17.NumBits), &aper.Constraint{Lb: 12, Ub: 12}, false); err != nil {
...
func (ie *CG_SDT_Configuration_r17_sdt_DMRS_Ports_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	case CG_SDT_Configuration_r17_sdt_DMRS_Ports_r17_Choice_DmrsType1_r17:
		...
		if tmp_bs_DmrsType1_r17, n_DmrsType1_r17, err = r.ReadBitString(&aper.Constraint{Lb: 8, Ub: 8}, false); err != nil {
			return utils.WrapError("Decode DmrsType1_r17", err)
		}
		ie.DmrsType1_r17 = aper.BitString{
	...
	case CG_SDT_Configuration_r17_sdt_DMRS_Ports_r17_Choice_DmrsType2_r17:
		...
		if tmp_bs_DmrsType2_r17, n_DmrsType2_r17, err = r.ReadBitString(&aper.Constraint{Lb: 12, Ub: 12}, false); err != nil {
			return utils.WrapError("Decode DmrsType2_r17", err)
		}
		ie.DmrsType2_r17 = aper.BitString{
