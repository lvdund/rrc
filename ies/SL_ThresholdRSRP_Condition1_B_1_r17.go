...
func (ie *SL_ThresholdRSRP_Condition1_B_1_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.Sl_Priority_r17, &aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_Priority_r17", err)
	}
	if err = w.WriteInteger(ie.Sl_ThresholdRSRP_Condition1_B_1_r17, &aper.Constraint{Lb: 0, Ub: 66}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_ThresholdRSRP_Condition1_B_1_r17", err)
	}
	return nil
}

func (ie *SL_ThresholdRSRP_Condition1_B_1_r17) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_Sl_Priority_r17 int64
	if tmp_int_Sl_Priority_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 8}, false); err != nil {
	...
	if tmp_int_Sl_ThresholdRSRP_Condition1_B_1_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 66}, false); err != nil {
