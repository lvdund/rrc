...
func (ie *UECapabilityEnquiry_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UECapabilityEnquiry_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
