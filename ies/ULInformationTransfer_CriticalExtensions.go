...
func (ie *ULInformationTransfer_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ULInformationTransfer_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
