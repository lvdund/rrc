...
func (ie *PerRAInfoList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*PerRAInfo_r16]([]*PerRAInfo_r16{}, aper.Constraint{Lb: 1, Ub: 200}, false)
...
func (ie *PerRAInfoList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*PerRAInfo_r16]([]*PerRAInfo_r16{}, aper.Constraint{Lb: 1, Ub: 200}, false)
