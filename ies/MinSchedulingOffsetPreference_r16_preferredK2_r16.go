...
func (ie *MinSchedulingOffsetPreference_r16_preferredK2_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MinSchedulingOffsetPreference_r16_preferredK2_r16) Decode(r *aper.AperReader) error {
	var err error
