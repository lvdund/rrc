...
type ServCellInfoListSCG_EUTRA_r16 struct {
	Value []ServCellInfoXCG_EUTRA_r16 `lb:1,ub:maxNrofServingCellsEUTRA,madatory`
}

func (ie *ServCellInfoListSCG_EUTRA_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ServCellInfoListSCG_EUTRA_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*ServCellInfoXCG_EUTRA_r16]([]*ServCellInfoXCG_EUTRA_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofServingCellsEUTRA}, false)
