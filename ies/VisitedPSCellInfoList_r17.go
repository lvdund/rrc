...
func (ie *VisitedPSCellInfoList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*VisitedPSCellInfo_r17]([]*VisitedPSCellInfo_r17{}, aper.Constraint{Lb: 1, Ub: maxPSCellHistory_r17}, false)
...
func (ie *VisitedPSCellInfoList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*VisitedPSCellInfo_r17]([]*VisitedPSCellInfo_r17{}, aper.Constraint{Lb: 1, Ub: maxPSCellHistory_r17}, false)
