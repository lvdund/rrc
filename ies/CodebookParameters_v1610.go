...
func (ie *CodebookParameters_v1610) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.SupportedCSI_RS_ResourceListAlt_r16) > 0 {
		tmp_SupportedCSI_RS_ResourceListAlt_r16 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_Resources}, false)
...
func (ie *CodebookParameters_v1610) Decode(r *aper.AperReader) error {
	var err error
