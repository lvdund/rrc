...
func (ie *SliceInfoListDedicated_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SliceInfoDedicated_r17]([]*SliceInfoDedicated_r17{}, aper.Constraint{Lb: 1, Ub: maxSliceInfo_r17}, false)
...
func (ie *SliceInfoListDedicated_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SliceInfoDedicated_r17]([]*SliceInfoDedicated_r17{}, aper.Constraint{Lb: 1, Ub: maxSliceInfo_r17}, false)
