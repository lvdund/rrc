...
func (ie *DMRS_UplinkConfig_transformPrecodingDisabled) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *DMRS_UplinkConfig_transformPrecodingDisabled) Decode(r *aper.AperReader) error {
	var err error
