...
func (ie *RRCReconfigurationCompleteSidelink_r16_IEs) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *RRCReconfigurationCompleteSidelink_r16_IEs) Decode(r *uper.UperReader) error {
	var err error
