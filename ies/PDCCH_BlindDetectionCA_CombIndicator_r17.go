...
func (ie *PDCCH_BlindDetectionCA_CombIndicator_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PDCCH_BlindDetectionCA_CombIndicator_r17) Decode(r *aper.AperReader) error {
	var err error
