...
func (ie *EventTriggerConfigInterRAT_eventId_eventB2_UTRA_FDD_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *EventTriggerConfigInterRAT_eventId_eventB2_UTRA_FDD_r16) Decode(r *uper.UperReader) error {
	var err error
