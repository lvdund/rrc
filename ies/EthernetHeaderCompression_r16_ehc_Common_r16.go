...
func (ie *EthernetHeaderCompression_r16_ehc_Common_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *EthernetHeaderCompression_r16_ehc_Common_r16) Decode(r *aper.AperReader) error {
	var err error
