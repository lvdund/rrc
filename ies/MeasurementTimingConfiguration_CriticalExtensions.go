...
func (ie *MeasurementTimingConfiguration_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasurementTimingConfiguration_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
