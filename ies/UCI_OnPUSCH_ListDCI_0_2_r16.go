...
func (ie *UCI_OnPUSCH_ListDCI_0_2_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*UCI_OnPUSCH_DCI_0_2_r16]([]*UCI_OnPUSCH_DCI_0_2_r16{}, aper.Constraint{Lb: 1, Ub: 2}, false)
...
func (ie *UCI_OnPUSCH_ListDCI_0_2_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*UCI_OnPUSCH_DCI_0_2_r16]([]*UCI_OnPUSCH_DCI_0_2_r16{}, aper.Constraint{Lb: 1, Ub: 2}, false)
