...
func (ie *SL_RxInterestedGC_BC_DestList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_RxInterestedGC_BC_Dest_r17]([]*SL_RxInterestedGC_BC_Dest_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofSL_Dest_r16}, false)
...
func (ie *SL_RxInterestedGC_BC_DestList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_RxInterestedGC_BC_Dest_r17]([]*SL_RxInterestedGC_BC_Dest_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofSL_Dest_r16}, false)
