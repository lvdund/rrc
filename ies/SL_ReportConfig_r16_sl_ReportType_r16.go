...
func (ie *SL_ReportConfig_r16_sl_ReportType_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SL_ReportConfig_r16_sl_ReportType_r16) Decode(r *aper.AperReader) error {
	var err error
