...
func (ie *SFTD_FrequencyList_NR) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*ARFCN_ValueNR]([]*ARFCN_ValueNR{}, aper.Constraint{Lb: 1, Ub: maxCellSFTD}, false)
...
func (ie *SFTD_FrequencyList_NR) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*ARFCN_ValueNR]([]*ARFCN_ValueNR{}, aper.Constraint{Lb: 1, Ub: maxCellSFTD}, false)
