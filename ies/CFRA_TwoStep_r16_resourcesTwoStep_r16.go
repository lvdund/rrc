...
func (ie *CFRA_TwoStep_r16_resourcesTwoStep_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CFRA_TwoStep_r16_resourcesTwoStep_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp_Ssb_ResourceList := utils.NewSequence[*CFRA_SSB_Resource]([]*CFRA_SSB_Resource{}, aper.Constraint{Lb: 1, Ub: maxRA_SSB_Resources}, false)
