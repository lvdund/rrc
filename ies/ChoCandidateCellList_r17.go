...
func (ie *ChoCandidateCellList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*ChoCandidateCell_r17]([]*ChoCandidateCell_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofCondCells_r16}, false)
...
func (ie *ChoCandidateCellList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*ChoCandidateCell_r17]([]*ChoCandidateCell_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofCondCells_r16}, false)
