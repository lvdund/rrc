...
func (ie *FeatureSetDownlink_v1700_timeDurationForQCL_v1710) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *FeatureSetDownlink_v1700_timeDurationForQCL_v1710) Decode(r *aper.AperReader) error {
	var err error
