...
func (ie *SCGFailureInformationEUTRA_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SCGFailureInformationEUTRA_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
