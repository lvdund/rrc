...
type SL_TxInterestedFreqList_r16 struct {
	Value []int64 `lb:1,ub:maxNrofFreqSL_r16,madatory`
}

func (ie *SL_TxInterestedFreqList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofFreqSL_r16}, false)
...
func (ie *SL_TxInterestedFreqList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofFreqSL_r16}, false)
