...
func (ie *RRCSystemInfoRequest_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RRCSystemInfoRequest_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
