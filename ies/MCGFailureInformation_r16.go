...
type MCGFailureInformation_r16 struct {
	CriticalExtensions MCGFailureInformation_r16_CriticalExtensions `madatory`
}

func (ie *MCGFailureInformation_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *MCGFailureInformation_r16) Decode(r *uper.UperReader) error {
	var err error
