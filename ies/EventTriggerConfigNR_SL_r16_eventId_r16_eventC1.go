...
func (ie *EventTriggerConfigNR_SL_r16_eventId_r16_eventC1) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *EventTriggerConfigNR_SL_r16_eventId_r16_eventC1) Decode(r *uper.UperReader) error {
	var err error
