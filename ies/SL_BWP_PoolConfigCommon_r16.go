...
type SL_BWP_PoolConfigCommon_r16 struct {
	...
	Sl_TxPoolSelectedNormal_r16 []SL_ResourcePoolConfig_r16 `lb:1,ub:maxNrofTXPool_r16,optional`
...
func (ie *SL_BWP_PoolConfigCommon_r16) Encode(w *uper.UperWriter) error {
	...
	if len(ie.Sl_TxPoolSelectedNormal_r16) > 0 {
		...
		if err = tmp_Sl_TxPoolSelectedNormal_r16.Encode(w); err != nil {
...
func (ie *SL_BWP_PoolConfigCommon_r16) Decode(r *uper.UperReader) error {
	...
	if Sl_TxPoolSelectedNormal_r16Present {
		...
		if err = tmp_Sl_TxPoolSelectedNormal_r16.Decode(r, fn_Sl_TxPoolSelectedNormal_r16); err != nil {
			return utils.WrapError("Decode Sl_TxPoolSelectedNormal_r16", err)
		}
		ie.Sl_TxPoolSelectedNormal_r16 = []SL_ResourcePoolConfig_r16{}
		for _, i := range tmp_Sl_TxPoolSelectedNormal_r16.Value {
			ie.Sl_TxPoolSelectedNormal_r16 = append(ie.Sl_TxPoolSelectedNormal_r16, *i)
		}
	}
