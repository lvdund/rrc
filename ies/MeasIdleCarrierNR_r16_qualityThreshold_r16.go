...
func (ie *MeasIdleCarrierNR_r16_qualityThreshold_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasIdleCarrierNR_r16_qualityThreshold_r16) Decode(r *aper.AperReader) error {
	var err error
