...
type UECapabilityEnquirySidelink struct {
	...
	CriticalExtensions            UECapabilityEnquirySidelink_CriticalExtensions `madatory`
}

func (ie *UECapabilityEnquirySidelink) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *UECapabilityEnquirySidelink) Decode(r *uper.UperReader) error {
	var err error
