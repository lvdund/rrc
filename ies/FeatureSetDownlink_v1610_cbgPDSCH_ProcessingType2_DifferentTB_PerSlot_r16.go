...
func (ie *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16) Decode(r *aper.AperReader) error {
	var err error
