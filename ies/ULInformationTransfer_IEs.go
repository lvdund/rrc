...
type ULInformationTransfer_IEs struct {
	...
	NonCriticalExtension     *ULInformationTransfer_v1700_IEs `optional`
}

func (ie *ULInformationTransfer_IEs) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ULInformationTransfer_IEs) Decode(r *aper.AperReader) error {
	var err error
