...
func (ie *CellsToAddModList) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*CellsToAddMod]([]*CellsToAddMod{}, aper.Constraint{Lb: 1, Ub: maxNrofCellMeas}, false)
...
func (ie *CellsToAddModList) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*CellsToAddMod]([]*CellsToAddMod{}, aper.Constraint{Lb: 1, Ub: maxNrofCellMeas}, false)
