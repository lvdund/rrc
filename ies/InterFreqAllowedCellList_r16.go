...
type InterFreqAllowedCellList_r16 struct {
	Value []PCI_Range `lb:1,ub:maxCellAllowed,madatory`
}

func (ie *InterFreqAllowedCellList_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *InterFreqAllowedCellList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*PCI_Range]([]*PCI_Range{}, aper.Constraint{Lb: 1, Ub: maxCellAllowed}, false)
	fn := func() *PCI_Range {
