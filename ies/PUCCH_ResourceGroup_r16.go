...
func (ie *PUCCH_ResourceGroup_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = ie.Pucch_ResourceGroupId_r16.Encode(w); err != nil {
		return utils.WrapError("Encode Pucch_ResourceGroupId_r16", err)
	}
	tmp_ResourcePerGroupList_r16 := utils.NewSequence[*PUCCH_ResourceId]([]*PUCCH_ResourceId{}, aper.Constraint{Lb: 1, Ub: maxNrofPUCCH_ResourcesPerGroup_r16}, false)
...
func (ie *PUCCH_ResourceGroup_r16) Decode(r *aper.AperReader) error {
	var err error
