...
func (ie *NTN_NeighCellConfigList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*NTN_NeighCellConfig_r17]([]*NTN_NeighCellConfig_r17{}, aper.Constraint{Lb: 1, Ub: maxCellNTN_r17}, false)
...
func (ie *NTN_NeighCellConfigList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*NTN_NeighCellConfig_r17]([]*NTN_NeighCellConfig_r17{}, aper.Constraint{Lb: 1, Ub: maxCellNTN_r17}, false)
