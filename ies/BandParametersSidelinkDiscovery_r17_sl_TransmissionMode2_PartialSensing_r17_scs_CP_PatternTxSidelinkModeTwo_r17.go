...
func (ie *BandParametersSidelinkDiscovery_r17_sl_TransmissionMode2_PartialSensing_r17_scs_CP_PatternTxSidelinkModeTwo_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *BandParametersSidelinkDiscovery_r17_sl_TransmissionMode2_PartialSensing_r17_scs_CP_PatternTxSidelinkModeTwo_r17) Decode(r *aper.AperReader) error {
	var err error
