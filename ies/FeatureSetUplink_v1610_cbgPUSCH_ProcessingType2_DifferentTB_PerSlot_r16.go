...
func (ie *FeatureSetUplink_v1610_cbgPUSCH_ProcessingType2_DifferentTB_PerSlot_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *FeatureSetUplink_v1610_cbgPUSCH_ProcessingType2_DifferentTB_PerSlot_r16) Decode(r *aper.AperReader) error {
	var err error
