...
func (ie *SSB_PositionQCL_CellList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SSB_PositionQCL_Cell_r17]([]*SSB_PositionQCL_Cell_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofCellMeas}, false)
...
func (ie *SSB_PositionQCL_CellList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SSB_PositionQCL_Cell_r17]([]*SSB_PositionQCL_Cell_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofCellMeas}, false)
