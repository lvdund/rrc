...
type ServingCellConfigCommonSIB_channelAccessMode_r16 struct {
	Choice     uint64
	Dynamic    aper.NULL `madatory`
	SemiStatic *SemiStaticChannelAccessConfig_r16
}

func (ie *ServingCellConfigCommonSIB_channelAccessMode_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ServingCellConfigCommonSIB_channelAccessMode_r16) Decode(r *aper.AperReader) error {
	var err error
