...
type DLInformationTransfer struct {
	...
	CriticalExtensions        DLInformationTransfer_CriticalExtensions `madatory`
}

func (ie *DLInformationTransfer) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *DLInformationTransfer) Decode(r *uper.UperReader) error {
	var err error
