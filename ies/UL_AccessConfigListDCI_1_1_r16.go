...
type UL_AccessConfigListDCI_1_1_r16 struct {
	Value []int64 `lb:1,ub:16,madatory`
}

func (ie *UL_AccessConfigListDCI_1_1_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: 16}, false)
...
func (ie *UL_AccessConfigListDCI_1_1_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: 16}, false)
