...
func (ie *SSB_MTC3_r16_periodicityAndOffset_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SSB_MTC3_r16_periodicityAndOffset_r16) Decode(r *aper.AperReader) error {
	var err error
