...
func (ie *MUSIM_GapPreferenceList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MUSIM_GapInfo_r17]([]*MUSIM_GapInfo_r17{}, aper.Constraint{Lb: 1, Ub: 4}, false)
...
func (ie *MUSIM_GapPreferenceList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MUSIM_GapInfo_r17]([]*MUSIM_GapInfo_r17{}, aper.Constraint{Lb: 1, Ub: 4}, false)
