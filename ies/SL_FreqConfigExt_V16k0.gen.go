...
// Source: SL-FreqConfigExt-v16k0 (line 27268).

var sLFreqConfigExtV16k0Constraints = per.SequenceConstraints{
	Extensible: false,
...
type SL_FreqConfigExt_V16k0 struct {
	AdditionalSpectrumEmission_r16 *AdditionalSpectrumEmission
}

func (ie *SL_FreqConfigExt_V16k0) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(sLFreqConfigExtV16k0Constraints)
...
func (ie *SL_FreqConfigExt_V16k0) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(sLFreqConfigExtV16k0Constraints)
