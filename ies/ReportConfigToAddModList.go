...
func (ie *ReportConfigToAddModList) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*ReportConfigToAddMod]([]*ReportConfigToAddMod{}, aper.Constraint{Lb: 1, Ub: maxReportConfigId}, false)
...
func (ie *ReportConfigToAddModList) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*ReportConfigToAddMod]([]*ReportConfigToAddMod{}, aper.Constraint{Lb: 1, Ub: maxReportConfigId}, false)
