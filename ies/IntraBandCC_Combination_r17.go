...
func (ie *IntraBandCC_Combination_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*CC_State_r17]([]*CC_State_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofServingCells}, false)
...
func (ie *IntraBandCC_Combination_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*CC_State_r17]([]*CC_State_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofServingCells}, false)
