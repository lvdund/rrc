...
func (ie *CellGlobalIdList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*CGI_Info_Logging_r16]([]*CGI_Info_Logging_r16{}, aper.Constraint{Lb: 1, Ub: 32}, false)
...
func (ie *CellGlobalIdList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*CGI_Info_Logging_r16]([]*CGI_Info_Logging_r16{}, aper.Constraint{Lb: 1, Ub: 32}, false)
