...
func (ie *SL_PSSCH_TxParameters_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.Sl_MinMCS_PSSCH_r16, &aper.Constraint{Lb: 0, Ub: 27}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_MinMCS_PSSCH_r16", err)
	}
	if err = w.WriteInteger(ie.Sl_MaxMCS_PSSCH_r16, &aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_MaxMCS_PSSCH_r16", err)
	}
	if err = w.WriteInteger(ie.Sl_MinSubChannelNumPSSCH_r16, &aper.Constraint{Lb: 1, Ub: 27}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_MinSubChannelNumPSSCH_r16", err)
	}
	if err = w.WriteInteger(ie.Sl_MaxSubchannelNumPSSCH_r16, &aper.Constraint{Lb: 1, Ub: 27}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_MaxSubchannelNumPSSCH_r16", err)
	}
	if err = w.WriteInteger(ie.Sl_MaxTxTransNumPSSCH_r16, &aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
...
func (ie *SL_PSSCH_TxParameters_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_Sl_MinMCS_PSSCH_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 27}, false); err != nil {
	...
	if tmp_int_Sl_MaxMCS_PSSCH_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
	...
	if tmp_int_Sl_MinSubChannelNumPSSCH_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 27}, false); err != nil {
	...
	if tmp_int_Sl_MaxSubchannelNumPSSCH_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 27}, false); err != nil {
	...
	if tmp_int_Sl_MaxTxTransNumPSSCH_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 32}, false); err != nil {
