...
func (ie *SL_PHY_MAC_RLC_Config_v1700) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.Sl_RLC_ChannelToReleaseList_r17) > 0 {
		tmp_Sl_RLC_ChannelToReleaseList_r17 := utils.NewSequence[*SL_RLC_ChannelID_r17]([]*SL_RLC_ChannelID_r17{}, aper.Constraint{Lb: 1, Ub: maxSL_LCID_r16}, false)
	...
	if len(ie.Sl_RLC_ChannelToAddModList_r17) > 0 {
		tmp_Sl_RLC_ChannelToAddModList_r17 := utils.NewSequence[*SL_RLC_ChannelConfig_r17]([]*SL_RLC_ChannelConfig_r17{}, aper.Constraint{Lb: 1, Ub: maxSL_LCID_r16}, false)
...
func (ie *SL_PHY_MAC_RLC_Config_v1700) Decode(r *aper.AperReader) error {
	var err error
