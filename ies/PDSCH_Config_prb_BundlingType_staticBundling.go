...
func (ie *PDSCH_Config_prb_BundlingType_staticBundling) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PDSCH_Config_prb_BundlingType_staticBundling) Decode(r *aper.AperReader) error {
	var err error
