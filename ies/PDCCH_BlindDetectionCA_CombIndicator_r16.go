...
func (ie *PDCCH_BlindDetectionCA_CombIndicator_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *PDCCH_BlindDetectionCA_CombIndicator_r16) Decode(r *uper.UperReader) error {
	var err error
