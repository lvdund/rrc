...
func (ie *PDCCH_BlindDetectionCA_CombIndicator_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PDCCH_BlindDetectionCA_CombIndicator_r16) Decode(r *aper.AperReader) error {
	var err error
