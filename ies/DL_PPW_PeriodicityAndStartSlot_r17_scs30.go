...
func (ie *DL_PPW_PeriodicityAndStartSlot_r17_scs30) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *DL_PPW_PeriodicityAndStartSlot_r17_scs30) Decode(r *aper.AperReader) error {
	var err error
