...
func (ie *SIB_Mapping) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SIB_TypeInfo]([]*SIB_TypeInfo{}, aper.Constraint{Lb: 1, Ub: maxSIB}, false)
...
func (ie *SIB_Mapping) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SIB_TypeInfo]([]*SIB_TypeInfo{}, aper.Constraint{Lb: 1, Ub: maxSIB}, false)
