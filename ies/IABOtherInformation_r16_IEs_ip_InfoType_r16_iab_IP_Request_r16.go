...
func (ie *IABOtherInformation_r16_IEs_ip_InfoType_r16_iab_IP_Request_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *IABOtherInformation_r16_IEs_ip_InfoType_r16_iab_IP_Request_r16) Decode(r *aper.AperReader) error {
	var err error
