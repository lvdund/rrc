...
func (ie *SRS_SpatialRelationInfo_referenceSignal) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *SRS_SpatialRelationInfo_referenceSignal) Decode(r *uper.UperReader) error {
	var err error
