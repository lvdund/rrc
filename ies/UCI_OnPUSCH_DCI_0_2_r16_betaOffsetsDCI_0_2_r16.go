...
func (ie *UCI_OnPUSCH_DCI_0_2_r16_betaOffsetsDCI_0_2_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UCI_OnPUSCH_DCI_0_2_r16_betaOffsetsDCI_0_2_r16) Decode(r *aper.AperReader) error {
	var err error
