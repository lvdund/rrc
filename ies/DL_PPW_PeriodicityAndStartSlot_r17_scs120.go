...
func (ie *DL_PPW_PeriodicityAndStartSlot_r17_scs120) Encode(w *uper.UperWriter) error {
	var err error
	...
	case DL_PPW_PeriodicityAndStartSlot_r17_scs120_Choice_N512:
		if err = w.WriteInteger(int64(ie.N512), &uper.Constraint{Lb: 0, Ub: 511}, false); err != nil {
	...
	case DL_PPW_PeriodicityAndStartSlot_r17_scs120_Choice_N81920:
		if err = w.WriteInteger(int64(ie.N81920), &uper.Constraint{Lb: 0, Ub: 81919}, false); err != nil {
...
func (ie *DL_PPW_PeriodicityAndStartSlot_r17_scs120) Decode(r *uper.UperReader) error {
	var err error
	...
	case DL_PPW_PeriodicityAndStartSlot_r17_scs120_Choice_N512:
		...
		if tmp_int_N512, err = r.ReadInteger(&uper.Constraint{Lb: 0, Ub: 511}, false); err != nil {
	...
	case DL_PPW_PeriodicityAndStartSlot_r17_scs120_Choice_N81920:
		...
		if tmp_int_N81920, err = r.ReadInteger(&uper.Constraint{Lb: 0, Ub: 81919}, false); err != nil {
