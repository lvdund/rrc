...
func (ie *UE_TxTEG_AssociationList_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*UE_TxTEG_Association_r17]([]*UE_TxTEG_Association_r17{}, aper.Constraint{Lb: 1, Ub: maxNrOfTxTEGReport_r17}, false)
...
func (ie *UE_TxTEG_AssociationList_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*UE_TxTEG_Association_r17]([]*UE_TxTEG_Association_r17{}, aper.Constraint{Lb: 1, Ub: maxNrOfTxTEGReport_r17}, false)
