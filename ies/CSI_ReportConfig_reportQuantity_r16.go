...
type CSI_ReportConfig_reportQuantity_r16 struct {
	Choice             uint64
	Cri_SINR_r16       aper.NULL `madatory`
	Ssb_Index_SINR_r16 aper.NULL `madatory`
}

func (ie *CSI_ReportConfig_reportQuantity_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CSI_ReportConfig_reportQuantity_r16) Decode(r *aper.AperReader) error {
	var err error
