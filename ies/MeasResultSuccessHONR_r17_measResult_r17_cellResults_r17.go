...
func (ie *MeasResultSuccessHONR_r17_measResult_r17_cellResults_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MeasResultSuccessHONR_r17_measResult_r17_cellResults_r17) Decode(r *aper.AperReader) error {
	var err error
