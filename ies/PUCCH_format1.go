...
func (ie *PUCCH_format1) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.TimeDomainOCC, &aper.Constraint{Lb: 0, Ub: 6}, false); err != nil {
		return utils.WrapError("WriteInteger TimeDomainOCC", err)
	}
	return nil
}

func (ie *PUCCH_format1) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_TimeDomainOCC, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 6}, false); err != nil {
