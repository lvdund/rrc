...
func (ie *BandCombinationList_v1720) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1720]([]*BandCombination_v1720{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v1720) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1720]([]*BandCombination_v1720{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
