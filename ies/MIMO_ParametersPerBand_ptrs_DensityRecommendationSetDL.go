...
func (ie *MIMO_ParametersPerBand_ptrs_DensityRecommendationSetDL) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *MIMO_ParametersPerBand_ptrs_DensityRecommendationSetDL) Decode(r *aper.AperReader) error {
	var err error
