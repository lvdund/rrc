...
func (ie *CellGrouping_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp_Mcg_r16 := utils.NewSequence[*FreqBandIndicatorNR]([]*FreqBandIndicatorNR{}, aper.Constraint{Lb: 1, Ub: maxBands}, false)
	...
	tmp_Scg_r16 := utils.NewSequence[*FreqBandIndicatorNR]([]*FreqBandIndicatorNR{}, aper.Constraint{Lb: 1, Ub: maxBands}, false)
...
func (ie *CellGrouping_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp_Mcg_r16 := utils.NewSequence[*FreqBandIndicatorNR]([]*FreqBandIndicatorNR{}, aper.Constraint{Lb: 1, Ub: maxBands}, false)
