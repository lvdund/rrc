...
func (ie *CLI_EventTriggerConfig_r16_eventId_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CLI_EventTriggerConfig_r16_eventId_r16) Decode(r *aper.AperReader) error {
	var err error
