...
func (ie *FreqPriorityListSlicing_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*FreqPrioritySlicing_r17]([]*FreqPrioritySlicing_r17{}, aper.Constraint{Lb: 1, Ub: maxFreqPlus1}, false)
...
func (ie *FreqPriorityListSlicing_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*FreqPrioritySlicing_r17]([]*FreqPrioritySlicing_r17{}, aper.Constraint{Lb: 1, Ub: maxFreqPlus1}, false)
