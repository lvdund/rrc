...
type SRS_PosResource_r16_resourceMapping_r16 struct {
	StartPosition_r16 int64                                                   `lb:0,ub:13,madatory`
	NrofSymbols_r16   SRS_PosResource_r16_resourceMapping_r16_nrofSymbols_r16 `madatory`
}

func (ie *SRS_PosResource_r16_resourceMapping_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *SRS_PosResource_r16_resourceMapping_r16) Decode(r *uper.UperReader) error {
	var err error
