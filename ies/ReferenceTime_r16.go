...
func (ie *ReferenceTime_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.RefDays_r16, &aper.Constraint{Lb: 0, Ub: 72999}, false); err != nil {
		return utils.WrapError("WriteInteger RefDays_r16", err)
	}
	if err = w.WriteInteger(ie.RefSeconds_r16, &aper.Constraint{Lb: 0, Ub: 86399}, false); err != nil {
		return utils.WrapError("WriteInteger RefSeconds_r16", err)
	}
	if err = w.WriteInteger(ie.RefMilliSeconds_r16, &aper.Constraint{Lb: 0, Ub: 999}, false); err != nil {
		return utils.WrapError("WriteInteger RefMilliSeconds_r16", err)
	}
	if err = w.WriteInteger(ie.RefTenNanoSeconds_r16, &aper.Constraint{Lb: 0, Ub: 99999}, false); err != nil {
		return utils.WrapError("WriteInteger RefTenNanoSeconds_r16", err)
	}
	return nil
}

func (ie *ReferenceTime_r16) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_RefDays_r16 int64
	if tmp_int_RefDays_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 72999}, false); err != nil {
		return utils.WrapError("ReadInteger RefDays_r16", err)
	}
	ie.RefDays_r16 = tmp_int_RefDays_r16
	var tmp_int_RefSeconds_r16 int64
	if tmp_int_RefSeconds_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 86399}, false); err != nil {
	...
	if tmp_int_RefMilliSeconds_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 999}, false); err != nil {
	...
	if tmp_int_RefTenNanoSeconds_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 99999}, false); err != nil {
