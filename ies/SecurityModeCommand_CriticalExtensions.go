...
func (ie *SecurityModeCommand_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SecurityModeCommand_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
