...
func (ie *SL_PeriodCG_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	case SL_PeriodCG_r16_Choice_Sl_PeriodCG2_r16:
		if err = w.WriteInteger(int64(ie.Sl_PeriodCG2_r16), &aper.Constraint{Lb: 1, Ub: 99}, false); err != nil {
...
func (ie *SL_PeriodCG_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	case SL_PeriodCG_r16_Choice_Sl_PeriodCG2_r16:
		...
		if tmp_int_Sl_PeriodCG2_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 99}, false); err != nil {
