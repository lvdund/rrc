...
func (ie *RA_ReportList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*RA_Report_r16]([]*RA_Report_r16{}, aper.Constraint{Lb: 1, Ub: maxRAReport_r16}, false)
...
func (ie *RA_ReportList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*RA_Report_r16]([]*RA_Report_r16{}, aper.Constraint{Lb: 1, Ub: maxRAReport_r16}, false)
