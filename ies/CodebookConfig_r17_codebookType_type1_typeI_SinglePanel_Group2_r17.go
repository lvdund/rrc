...
func (ie *CodebookConfig_r17_codebookType_type1_typeI_SinglePanel_Group2_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CodebookConfig_r17_codebookType_type1_typeI_SinglePanel_Group2_r17) Decode(r *aper.AperReader) error {
	var err error
