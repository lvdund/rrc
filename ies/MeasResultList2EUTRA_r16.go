...
func (ie *MeasResultList2EUTRA_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MeasResult2EUTRA_r16]([]*MeasResult2EUTRA_r16{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
...
func (ie *MeasResultList2EUTRA_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MeasResult2EUTRA_r16]([]*MeasResult2EUTRA_r16{}, aper.Constraint{Lb: 1, Ub: maxFreq}, false)
