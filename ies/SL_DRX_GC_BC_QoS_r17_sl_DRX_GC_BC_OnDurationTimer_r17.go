...
func (ie *SL_DRX_GC_BC_QoS_r17_sl_DRX_GC_BC_OnDurationTimer_r17) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *SL_DRX_GC_BC_QoS_r17_sl_DRX_GC_BC_OnDurationTimer_r17) Decode(r *uper.UperReader) error {
	var err error
