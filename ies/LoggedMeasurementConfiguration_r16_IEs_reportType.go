...
func (ie *LoggedMeasurementConfiguration_r16_IEs_reportType) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *LoggedMeasurementConfiguration_r16_IEs_reportType) Decode(r *aper.AperReader) error {
	var err error
