...
func (ie *RRCReconfigurationSidelink_r16_IEs) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.Slrb_ConfigToAddModList_r16) > 0 {
		tmp_Slrb_ConfigToAddModList_r16 := utils.NewSequence[*SLRB_Config_r16]([]*SLRB_Config_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofSLRB_r16}, false)
	...
	if len(ie.Slrb_ConfigToReleaseList_r16) > 0 {
		tmp_Slrb_ConfigToReleaseList_r16 := utils.NewSequence[*SLRB_PC5_ConfigIndex_r16]([]*SLRB_PC5_ConfigIndex_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofSLRB_r16}, false)
	...
	if ie.Sl_LatencyBoundCSI_Report_r16 != nil {
		if err = w.WriteInteger(*ie.Sl_LatencyBoundCSI_Report_r16, &aper.Constraint{Lb: 3, Ub: 160}, false); err != nil {
...
func (ie *RRCReconfigurationSidelink_r16_IEs) Decode(r *aper.AperReader) error {
	var err error
	...
	if Sl_LatencyBoundCSI_Report_r16Present {
		...
		if tmp_int_Sl_LatencyBoundCSI_Report_r16, err = r.ReadInteger(&aper.Constraint{Lb: 3, Ub: 160}, false); err != nil {
