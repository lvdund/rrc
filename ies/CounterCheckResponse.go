...
type CounterCheckResponse struct {
	...
	CriticalExtensions        CounterCheckResponse_CriticalExtensions `madatory`
}

func (ie *CounterCheckResponse) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *CounterCheckResponse) Decode(r *aper.AperReader) error {
	var err error
