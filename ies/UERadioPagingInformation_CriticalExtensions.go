...
func (ie *UERadioPagingInformation_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UERadioPagingInformation_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
