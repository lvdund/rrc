...
func (ie *SL_DRX_ConfigUC_SemiStatic_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.Sl_drx_SlotOffset_r17, &aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
		return utils.WrapError("WriteInteger Sl_drx_SlotOffset_r17", err)
	}
	return nil
}

func (ie *SL_DRX_ConfigUC_SemiStatic_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_Sl_drx_SlotOffset_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 31}, false); err != nil {
