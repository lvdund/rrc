...
func (ie *MinSchedulingOffsetPreferenceExt_r17_preferredK0_r17) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *MinSchedulingOffsetPreferenceExt_r17_preferredK0_r17) Decode(r *uper.UperReader) error {
	var err error
