...
func (ie *UplinkCancellation_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = ie.Ci_RNTI_r16.Encode(w); err != nil {
		return utils.WrapError("Encode Ci_RNTI_r16", err)
	}
	if err = w.WriteInteger(ie.Dci_PayloadSizeForCI_r16, &aper.Constraint{Lb: 0, Ub: maxCI_DCI_PayloadSize_r16}, false); err != nil {
		return utils.WrapError("WriteInteger Dci_PayloadSizeForCI_r16", err)
	}
	tmp_Ci_ConfigurationPerServingCell_r16 := utils.NewSequence[*CI_ConfigurationPerServingCell_r16]([]*CI_ConfigurationPerServingCell_r16{}, aper.Constraint{Lb: 1, Ub: maxNrofServingCells}, false)
...
func (ie *UplinkCancellation_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if tmp_int_Dci_PayloadSizeForCI_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: maxCI_DCI_PayloadSize_r16}, false); err != nil {
