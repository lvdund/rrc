...
func (ie *InvalidSymbolPattern_r16_periodicityAndPattern_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *InvalidSymbolPattern_r16_periodicityAndPattern_r16) Decode(r *aper.AperReader) error {
	var err error
