...
func (ie *RRCReconfigurationCompleteSidelink_CriticalExtensions) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *RRCReconfigurationCompleteSidelink_CriticalExtensions) Decode(r *uper.UperReader) error {
	var err error
