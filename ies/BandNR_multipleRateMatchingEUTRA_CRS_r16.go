...
func (ie *BandNR_multipleRateMatchingEUTRA_CRS_r16) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.MaxNumberPatterns_r16, &aper.Constraint{Lb: 2, Ub: 6}, false); err != nil {
		return utils.WrapError("WriteInteger MaxNumberPatterns_r16", err)
	}
	if err = w.WriteInteger(ie.MaxNumberNon_OverlapPatterns_r16, &aper.Constraint{Lb: 1, Ub: 3}, false); err != nil {
		return utils.WrapError("WriteInteger MaxNumberNon_OverlapPatterns_r16", err)
	}
	return nil
}

func (ie *BandNR_multipleRateMatchingEUTRA_CRS_r16) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_MaxNumberPatterns_r16 int64
	if tmp_int_MaxNumberPatterns_r16, err = r.ReadInteger(&aper.Constraint{Lb: 2, Ub: 6}, false); err != nil {
	...
	if tmp_int_MaxNumberNon_OverlapPatterns_r16, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 3}, false); err != nil {
