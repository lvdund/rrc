...
func (ie *BandCombinationList_v1650) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1650]([]*BandCombination_v1650{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
...
func (ie *BandCombinationList_v1650) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*BandCombination_v1650]([]*BandCombination_v1650{}, aper.Constraint{Lb: 1, Ub: maxBandComb}, false)
