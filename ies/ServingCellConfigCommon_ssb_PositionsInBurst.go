...
func (ie *ServingCellConfigCommon_ssb_PositionsInBurst) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *ServingCellConfigCommon_ssb_PositionsInBurst) Decode(r *aper.AperReader) error {
	var err error
