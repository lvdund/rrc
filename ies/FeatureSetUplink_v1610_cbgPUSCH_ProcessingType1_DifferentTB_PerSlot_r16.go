...
func (ie *FeatureSetUplink_v1610_cbgPUSCH_ProcessingType1_DifferentTB_PerSlot_r16) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *FeatureSetUplink_v1610_cbgPUSCH_ProcessingType1_DifferentTB_PerSlot_r16) Decode(r *uper.UperReader) error {
	var err error
