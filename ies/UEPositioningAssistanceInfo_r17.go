...
type UEPositioningAssistanceInfo_r17 struct {
	CriticalExtensions UEPositioningAssistanceInfo_r17_CriticalExtensions `madatory`
}

func (ie *UEPositioningAssistanceInfo_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *UEPositioningAssistanceInfo_r17) Decode(r *aper.AperReader) error {
	var err error
