...
func (ie *ReportUplinkTxDirectCurrentMoreCarrier_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*IntraBandCC_CombinationReqList_r17]([]*IntraBandCC_CombinationReqList_r17{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
...
func (ie *ReportUplinkTxDirectCurrentMoreCarrier_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*IntraBandCC_CombinationReqList_r17]([]*IntraBandCC_CombinationReqList_r17{}, aper.Constraint{Lb: 1, Ub: maxSimultaneousBands}, false)
