...
func (ie *SL_PSSCH_TxConfigList_r16) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*SL_PSSCH_TxConfig_r16]([]*SL_PSSCH_TxConfig_r16{}, aper.Constraint{Lb: 1, Ub: maxPSSCH_TxConfig_r16}, false)
...
func (ie *SL_PSSCH_TxConfigList_r16) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*SL_PSSCH_TxConfig_r16]([]*SL_PSSCH_TxConfig_r16{}, aper.Constraint{Lb: 1, Ub: maxPSSCH_TxConfig_r16}, false)
