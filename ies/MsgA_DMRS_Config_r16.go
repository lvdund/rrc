...
func (ie *MsgA_DMRS_Config_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	if ie.MsgA_PUSCH_DMRS_CDM_Group_r16 != nil {
		if err = w.WriteInteger(*ie.MsgA_PUSCH_DMRS_CDM_Group_r16, &aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
			return utils.WrapError("Encode MsgA_PUSCH_DMRS_CDM_Group_r16", err)
		}
	}
	if ie.MsgA_PUSCH_NrofPorts_r16 != nil {
		if err = w.WriteInteger(*ie.MsgA_PUSCH_NrofPorts_r16, &aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
			return utils.WrapError("Encode MsgA_PUSCH_NrofPorts_r16", err)
		}
	}
	if ie.MsgA_ScramblingID0_r16 != nil {
		if err = w.WriteInteger(*ie.MsgA_ScramblingID0_r16, &aper.Constraint{Lb: 0, Ub: 65535}, false); err != nil {
			return utils.WrapError("Encode MsgA_ScramblingID0_r16", err)
		}
	}
	if ie.MsgA_ScramblingID1_r16 != nil {
		if err = w.WriteInteger(*ie.MsgA_ScramblingID1_r16, &aper.Constraint{Lb: 0, Ub: 65535}, false); err != nil {
...
func (ie *MsgA_DMRS_Config_r16) Decode(r *aper.AperReader) error {
	var err error
	...
	if MsgA_PUSCH_DMRS_CDM_Group_r16Present {
		...
		if tmp_int_MsgA_PUSCH_DMRS_CDM_Group_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
	...
	if MsgA_PUSCH_NrofPorts_r16Present {
		...
		if tmp_int_MsgA_PUSCH_NrofPorts_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 1}, false); err != nil {
	...
	if MsgA_ScramblingID0_r16Present {
		...
		if tmp_int_MsgA_ScramblingID0_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 65535}, false); err != nil {
	...
	if MsgA_ScramblingID1_r16Present {
		...
		if tmp_int_MsgA_ScramblingID1_r16, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 65535}, false); err != nil {
