...
func (ie *SearchSpaceExt_v1700_searchSpaceType_r17_common_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SearchSpaceExt_v1700_searchSpaceType_r17_common_r17) Decode(r *aper.AperReader) error {
	var err error
