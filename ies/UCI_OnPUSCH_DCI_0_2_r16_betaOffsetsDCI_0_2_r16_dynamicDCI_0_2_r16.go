...
func (ie *UCI_OnPUSCH_DCI_0_2_r16_betaOffsetsDCI_0_2_r16_dynamicDCI_0_2_r16) Encode(w *aper.AperWriter) error {
	var err error
	...
	case UCI_OnPUSCH_DCI_0_2_r16_betaOffsetsDCI_0_2_r16_dynamicDCI_0_2_r16_Choice_OneBit_r16:
		tmp := utils.NewSequence[*BetaOffsets]([]*BetaOffsets{}, aper.Constraint{Lb: 2, Ub: 2}, false)
...
func (ie *UCI_OnPUSCH_DCI_0_2_r16_betaOffsetsDCI_0_2_r16_dynamicDCI_0_2_r16) Decode(r *aper.AperReader) error {
	var err error
