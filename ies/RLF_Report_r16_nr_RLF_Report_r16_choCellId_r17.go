...
func (ie *RLF_Report_r16_nr_RLF_Report_r16_choCellId_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RLF_Report_r16_nr_RLF_Report_r16_choCellId_r17) Decode(r *aper.AperReader) error {
	var err error
