...
func (ie *CodebookComboParameterMixedTypePerBC_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	if len(ie.Type1SP_feType2PS_M2R2_null_r17) > 0 {
		tmp_Type1SP_feType2PS_M2R2_null_r17 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, aper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesExt_r16}, false)
...
func (ie *CodebookComboParameterMixedTypePerBC_r17) Decode(r *aper.AperReader) error {
	var err error
