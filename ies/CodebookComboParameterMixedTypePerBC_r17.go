...
type CodebookComboParameterMixedTypePerBC_r17 struct {
	...
	Type1SP_feType2PS_M2R2_null_r17      []int64 `lb:1,ub:maxNrofCSI_RS_ResourcesExt_r16,e_lb:0,e_ub:maxNrofCSI_RS_ResourcesAlt_1_r16,optional`
...
func (ie *CodebookComboParameterMixedTypePerBC_r17) Encode(w *uper.UperWriter) error {
	...
	if len(ie.Type1SP_feType2PS_M2R2_null_r17) > 0 {
		tmp_Type1SP_feType2PS_M2R2_null_r17 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, uper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesExt_r16}, false)
		for _, i := range ie.Type1SP_feType2PS_M2R2_null_r17 {
			tmp_ie := utils.NewINTEGER(int64(i), uper.Constraint{Lb: 0, Ub: maxNrofCSI_RS_ResourcesAlt_1_r16}, false)
			tmp_Type1SP_feType2PS_M2R2_null_r17.Value = append(tmp_Type1SP_feType2PS_M2R2_null_r17.Value, &tmp_ie)
		}
		if err = tmp_Type1SP_feType2PS_M2R2_null_r17.Encode(w); err != nil {
			return utils.WrapError("Encode Type1SP_feType2PS_M2R2_null_r17", err)
		}
	}
...
func (ie *CodebookComboParameterMixedTypePerBC_r17) Decode(r *uper.UperReader) error {
	var err error
	...
	var Type1SP_feType2PS_M2R2_null_r17Present bool
	if Type1SP_feType2PS_M2R2_null_r17Present, err = r.ReadBool(); err != nil {
		return err
	}
	...
	if Type1SP_feType2PS_M2R2_null_r17Present {
		tmp_Type1SP_feType2PS_M2R2_null_r17 := utils.NewSequence[*utils.INTEGER]([]*utils.INTEGER{}, uper.Constraint{Lb: 1, Ub: maxNrofCSI_RS_ResourcesExt_r16}, false)
		fn_Type1SP_feType2PS_M2R2_null_r17 := func() *utils.INTEGER {
			ie := utils.NewINTEGER(0, uper.Constraint{Lb: 0, Ub: maxNrofCSI_RS_ResourcesAlt_1_r16}, false)
			return &ie
		}
		if err = tmp_Type1SP_feType2PS_M2R2_null_r17.Decode(r, fn_Type1SP_feType2PS_M2R2_null_r17); err != nil {
			return utils.WrapError("Decode Type1SP_feType2PS_M2R2_null_r17", err)
		}
		ie.Type1SP_feType2PS_M2R2_null_r17 = []int64{}
		for _, i := range tmp_Type1SP_feType2PS_M2R2_null_r17.Value {
			ie.Type1SP_feType2PS_M2R2_null_r17 = append(ie.Type1SP_feType2PS_M2R2_null_r17, int64(i.Value))
		}
	}
