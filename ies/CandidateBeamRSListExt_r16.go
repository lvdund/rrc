...
type CandidateBeamRSListExt_r16 struct {
...
func (ie *CandidateBeamRSListExt_r16) Encode(w *aper.AperWriter) error {
	...
	if err = tmp.Encode(w); err != nil {
		return utils.WrapError("Encode CandidateBeamRSListExt_r16", err)
	}
	return nil
}
...
func (ie *CandidateBeamRSListExt_r16) Decode(r *aper.AperReader) error {
	...
	if err = tmp.Decode(r, fn); err != nil {
		return utils.WrapError("Decode CandidateBeamRSListExt_r16", err)
	}
	ie.Value = []PRACH_ResourceDedicatedBFR{}
