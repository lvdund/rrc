...
type BandNR_channelBWs_UL_v1590_fr1 struct {
...
func (ie *BandNR_channelBWs_UL_v1590_fr1) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *BandNR_channelBWs_UL_v1590_fr1) Decode(r *uper.UperReader) error {
	var err error
