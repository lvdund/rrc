...
func (ie *SL_RLC_ConfigPC5_r16_sl_UM_Uni_Directional_RLC_r16) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SL_RLC_ConfigPC5_r16_sl_UM_Uni_Directional_RLC_r16) Decode(r *aper.AperReader) error {
	var err error
