...
func (ie *NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17) Encode(w *aper.AperWriter) error {
	var err error
	...
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N256_r17:
		if err = w.WriteInteger(int64(ie.N256_r17), &aper.Constraint{Lb: 0, Ub: 255}, false); err != nil {
	...
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N512_r17:
		if err = w.WriteInteger(int64(ie.N512_r17), &aper.Constraint{Lb: 0, Ub: 511}, false); err != nil {
	...
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N40960_r17:
		if err = w.WriteInteger(int64(ie.N40960_r17), &aper.Constraint{Lb: 0, Ub: 40959}, false); err != nil {
	...
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N81920_r17:
		if err = w.WriteInteger(int64(ie.N81920_r17), &aper.Constraint{Lb: 0, Ub: 81919}, false); err != nil {
...
func (ie *NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17) Decode(r *aper.AperReader) error {
	var err error
	...
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N256_r17:
		...
		if tmp_int_N256_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 255}, false); err != nil {
	...
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N512_r17:
		...
		if tmp_int_N512_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 511}, false); err != nil {
	...
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N40960_r17:
		...
		if tmp_int_N40960_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 40959}, false); err != nil {
			return utils.WrapError("Decode N40960_r17", err)
		}
		ie.N40960_r17 = tmp_int_N40960_r17
	case NR_DL_PRS_Periodicity_and_ResourceSetSlotOffset_r17_scs120_r17_Choice_N81920_r17:
		var tmp_int_N81920_r17 int64
		if tmp_int_N81920_r17, err = r.ReadInteger(&aper.Constraint{Lb: 0, Ub: 81919}, false); err != nil {
