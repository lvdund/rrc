...
func (ie *RRCReconfiguration_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *RRCReconfiguration_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
