...
func (ie *BandNR_triggeredHARQ_CodebookRetx_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *BandNR_triggeredHARQ_CodebookRetx_r17) Decode(r *aper.AperReader) error {
	var err error
