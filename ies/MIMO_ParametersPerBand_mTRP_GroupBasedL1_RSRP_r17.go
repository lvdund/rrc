...
func (ie *MIMO_ParametersPerBand_mTRP_GroupBasedL1_RSRP_r17) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.MaxNumBeamGroups_r17, &aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
...
func (ie *MIMO_ParametersPerBand_mTRP_GroupBasedL1_RSRP_r17) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_MaxNumBeamGroups_r17 int64
	if tmp_int_MaxNumBeamGroups_r17, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 4}, false); err != nil {
