...
func (ie *SL_DRX_ConfigUC_r17_sl_drx_CycleStartOffset_r17) Encode(w *uper.UperWriter) error {
	var err error
...
func (ie *SL_DRX_ConfigUC_r17_sl_drx_CycleStartOffset_r17) Decode(r *uper.UperReader) error {
	var err error
