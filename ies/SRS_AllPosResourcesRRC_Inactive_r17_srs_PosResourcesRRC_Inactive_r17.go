...
func (ie *SRS_AllPosResourcesRRC_Inactive_r17_srs_PosResourcesRRC_Inactive_r17) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *SRS_AllPosResourcesRRC_Inactive_r17_srs_PosResourcesRRC_Inactive_r17) Decode(r *aper.AperReader) error {
	var err error
