...
func (ie *IABOtherInformation_r16_CriticalExtensions) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *IABOtherInformation_r16_CriticalExtensions) Decode(r *aper.AperReader) error {
	var err error
