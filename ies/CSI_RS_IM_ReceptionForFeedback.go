...
func (ie *CSI_RS_IM_ReceptionForFeedback) Encode(w *aper.AperWriter) error {
	var err error
	if err = w.WriteInteger(ie.MaxConfigNumberNZP_CSI_RS_PerCC, &aper.Constraint{Lb: 1, Ub: 64}, false); err != nil {
		return utils.WrapError("WriteInteger MaxConfigNumberNZP_CSI_RS_PerCC", err)
	}
	if err = w.WriteInteger(ie.MaxConfigNumberPortsAcrossNZP_CSI_RS_PerCC, &aper.Constraint{Lb: 2, Ub: 256}, false); err != nil {
	...
	if err = w.WriteInteger(ie.MaxNumberSimultaneousNZP_CSI_RS_PerCC, &aper.Constraint{Lb: 1, Ub: 64}, false); err != nil {
		return utils.WrapError("WriteInteger MaxNumberSimultaneousNZP_CSI_RS_PerCC", err)
	}
	if err = w.WriteInteger(ie.TotalNumberPortsSimultaneousNZP_CSI_RS_PerCC, &aper.Constraint{Lb: 2, Ub: 256}, false); err != nil {
		return utils.WrapError("WriteInteger TotalNumberPortsSimultaneousNZP_CSI_RS_PerCC", err)
	}
	return nil
}

func (ie *CSI_RS_IM_ReceptionForFeedback) Decode(r *aper.AperReader) error {
	var err error
	var tmp_int_MaxConfigNumberNZP_CSI_RS_PerCC int64
	if tmp_int_MaxConfigNumberNZP_CSI_RS_PerCC, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 64}, false); err != nil {
	...
	if tmp_int_MaxConfigNumberPortsAcrossNZP_CSI_RS_PerCC, err = r.ReadInteger(&aper.Constraint{Lb: 2, Ub: 256}, false); err != nil {
	...
	if tmp_int_MaxNumberSimultaneousNZP_CSI_RS_PerCC, err = r.ReadInteger(&aper.Constraint{Lb: 1, Ub: 64}, false); err != nil {
	...
	if tmp_int_TotalNumberPortsSimultaneousNZP_CSI_RS_PerCC, err = r.ReadInteger(&aper.Constraint{Lb: 2, Ub: 256}, false); err != nil {
