...
func (ie *MBS_FSAI_List_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MBS_FSAI_r17]([]*MBS_FSAI_r17{}, aper.Constraint{Lb: 1, Ub: maxFSAI_MBS_r17}, false)
...
func (ie *MBS_FSAI_List_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MBS_FSAI_r17]([]*MBS_FSAI_r17{}, aper.Constraint{Lb: 1, Ub: maxFSAI_MBS_r17}, false)
