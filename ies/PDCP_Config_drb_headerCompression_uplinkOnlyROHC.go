...
func (ie *PDCP_Config_drb_headerCompression_uplinkOnlyROHC) Encode(w *aper.AperWriter) error {
	var err error
...
func (ie *PDCP_Config_drb_headerCompression_uplinkOnlyROHC) Decode(r *aper.AperReader) error {
	var err error
