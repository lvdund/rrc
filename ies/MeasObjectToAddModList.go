...
func (ie *MeasObjectToAddModList) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MeasObjectToAddMod]([]*MeasObjectToAddMod{}, aper.Constraint{Lb: 1, Ub: maxNrofObjectId}, false)
...
func (ie *MeasObjectToAddModList) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MeasObjectToAddMod]([]*MeasObjectToAddMod{}, aper.Constraint{Lb: 1, Ub: maxNrofObjectId}, false)
