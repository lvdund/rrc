...
func (ie *MultiPDSCH_TDRA_List_r17) Encode(w *aper.AperWriter) error {
	var err error
	tmp := utils.NewSequence[*MultiPDSCH_TDRA_r17]([]*MultiPDSCH_TDRA_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofDL_AllocationsExt_r17}, false)
...
func (ie *MultiPDSCH_TDRA_List_r17) Decode(r *aper.AperReader) error {
	var err error
	tmp := utils.NewSequence[*MultiPDSCH_TDRA_r17]([]*MultiPDSCH_TDRA_r17{}, aper.Constraint{Lb: 1, Ub: maxNrofDL_AllocationsExt_r17}, false)
