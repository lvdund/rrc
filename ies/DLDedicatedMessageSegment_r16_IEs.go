...
func (ie *DLDedicatedMessageSegment_r16_IEs) Encode(w *uper.UperWriter) error {
	var err error
	...
	if err = w.WriteInteger(ie.SegmentNumber_r16, &uper.Constraint{Lb: 0, Ub: 4}, false); err != nil {
...
func (ie *DLDedicatedMessageSegment_r16_IEs) Decode(r *uper.UperReader) error {
	var err error
	...
	if tmp_int_SegmentNumber_r16, err = r.ReadInteger(&uper.Constraint{Lb: 0, Ub: 4}, false); err != nil {
